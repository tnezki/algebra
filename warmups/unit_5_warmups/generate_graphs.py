...
# Unit 3 mastery figure needed by Unit 5 warmups.
def _u3_std(filename, functions=None):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    fig.patch.set_facecolor('white')
...
_u3_std('u3_bank_standard_blank_sq_v1.png', [])
plt.close('all')

# Unit 5 warmup generated diamond blocks.
# u5_warmup_5_1_1_diamond.png — V1 + P1 — factors 3 and 4
make_diamond('', r'$3$', r'$4$', '', 'u5_warmup_5_1_1_diamond.png')
plt.close('all')

# u5_warmup_5_1_2_diamond.png — V2 + P2 — factors 6 and -2
make_diamond(r'$-12$', '', '', r'$4$', 'u5_warmup_5_1_2_diamond.png')
plt.close('all')

# u5_warmup_5_1_3_diamond.png — V3 + P4 — factors -3 and -5
make_diamond(r'$15$', '', r'$-5$', '', 'u5_warmup_5_1_3_diamond.png')
plt.close('all')

# u5_warmup_5_2_1_diamond.png — V4 + P6 — factors 8 and 9
make_diamond('', '', r'$9$', r'$17$', 'u5_warmup_5_2_1_diamond.png')
plt.close('all')

# u5_warmup_5_2_2_diamond.png — V1 + P3 — factors 2 and 7
make_diamond(r'$14$', r'$2$', '', '', 'u5_warmup_5_2_2_diamond.png')
plt.close('all')

# u5_warmup_5_2_3_diamond.png — V2 + P5 — factors -4 and 9
make_diamond('', r'$-4$', '', r'$5$', 'u5_warmup_5_2_3_diamond.png')
plt.close('all')

# u5_warmup_5_3_1_diamond.png — V3 + P1 — factors -2 and -6
make_diamond('', r'$-2$', r'$-6$', '', 'u5_warmup_5_3_1_diamond.png')
plt.close('all')

# u5_warmup_5_3_2_diamond.png — V4 + P4 — factors -10 and 7
make_diamond(r'$-70$', '', r'$7$', '', 'u5_warmup_5_3_2_diamond.png')
plt.close('all')

# u5_warmup_5_3_3_diamond.png — V1 + P2 — factors 5 and 11
make_diamond(r'$55$', '', '', r'$16$', 'u5_warmup_5_3_3_diamond.png')
plt.close('all')

# u5_warmup_5_4_1_diamond.png — V2 + P6 — factors -8 and 3
make_diamond('', '', r'$3$', r'$-5$', 'u5_warmup_5_4_1_diamond.png')
plt.close('all')

# u5_warmup_5_4_2_diamond.png — V3 + P5 — factors -4 and -7
make_diamond('', r'$-4$', '', r'$-11$', 'u5_warmup_5_4_2_diamond.png')
plt.close('all')

# u5_warmup_5_4_3_diamond.png — V4 + P3 — factors 12 and -5
make_diamond(r'$-60$', r'$12$', '', '', 'u5_warmup_5_4_3_diamond.png')
plt.close('all')

# u5_warmup_5_5_1_diamond.png — V1 + P1 — factors 6 and 8
make_diamond('', r'$6$', r'$8$', '', 'u5_warmup_5_5_1_diamond.png')
plt.close('all')

# u5_warmup_5_5_2_diamond.png — V2 + P4 — factors 10 and -3
make_diamond(r'$-30$', '', r'$-3$', '', 'u5_warmup_5_5_2_diamond.png')
plt.close('all')

# u5_warmup_5_5_3_diamond.png — V5 + P6 — factors 0 and 9
make_diamond('', '', r'$9$', r'$9$', 'u5_warmup_5_5_3_diamond.png')
plt.close('all')
