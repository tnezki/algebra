...
# Additional warmup-selected Unit 2/3 bank figures and Unit 4 warmup diamonds.
# These calls use only authorized graph_tool.py functions.

# Selected Unit 2 bank figures used by warmups.
fig = make_2x2_grid([
...
# Selected Unit 3 bank figure used by warmups.
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
...
save_graph(fig, 'u3_bank_s1_parallel_sq_v1.png')
plt.close(fig)

make_diamond(r'', r'$3$', r'$5$', r'', filename='u4_warmup_4_1_1_diamond.png')
make_diamond(r'$-48$', r'', r'', r'$-2$', filename='u4_warmup_4_1_2_diamond.png')
make_diamond(r'$28$', r'', r'$-7$', r'', filename='u4_warmup_4_1_3_diamond.png')
make_diamond(r'', r'', r'$11$', r'$20$', filename='u4_warmup_4_2_1_diamond.png')
make_diamond(r'$14$', r'$2$', r'', r'', filename='u4_warmup_4_2_2_diamond.png')
make_diamond(r'', r'$-3$', r'', r'$7$', filename='u4_warmup_4_2_3_diamond.png')
make_diamond(r'', r'$-5$', r'$-6$', r'', filename='u4_warmup_4_3_1_diamond.png')
make_diamond(r'$84$', r'', r'$12$', r'', filename='u4_warmup_4_3_2_diamond.png')
make_diamond(r'$36$', r'', r'', r'$13$', filename='u4_warmup_4_3_3_diamond.png')
make_diamond(r'', r'', r'$4$', r'$-5$', filename='u4_warmup_4_4_1_diamond.png')
make_diamond(r'', r'$-2$', r'', r'$-10$', filename='u4_warmup_4_4_2_diamond.png')
make_diamond(r'$60$', r'$-12$', r'', r'', filename='u4_warmup_4_4_3_diamond.png')
make_diamond(r'', r'$6$', r'$7$', r'', filename='u4_warmup_4_5_1_diamond.png')
make_diamond(r'$-44$', r'', r'$-4$', r'', filename='u4_warmup_4_5_2_diamond.png')
make_diamond(r'', r'', r'$-9$', r'$-9$', filename='u4_warmup_4_5_3_diamond.png')
