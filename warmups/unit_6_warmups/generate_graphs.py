...
# Unit 6 warmups figure generation blocks.

def _warmup_std_fig(filename, functions=None, title=''):
...
def _warmup_two_grid(filename, functions_list, titles=None):
    fig = make_2x1_grid(functions_list, titles=titles)
    save_graph(fig, filename)
    plt.close(fig)

# Bank figures used by selected warmup items.
make_rectangle_model([r'$x$', r'$3$'], [r'$x$', r'$4$'], [[r'$x^2$', r'$4x$'], [r'$3x$', r'$12$']], 'u5_bank_s2_area_trinomial_sq_v1.png')
plt.close('all')

_warmup_std_fig('u4_bank_s2_blank_standard_sq_v1.png')

_warmup_two_grid('u4_bank_s3_abs_reflect_stretch_sq_v1.png', [
...
# Generated diamond warmup figures.
make_diamond('', r'$3$', r'$4$', '', 'u6_warmup_6_1_1_diamond.png')
plt.close('all')
make_diamond(r'$-30$', '', '', r'$-1$', 'u6_warmup_6_1_2_diamond.png')
plt.close('all')
make_diamond(r'$14$', '', r'$-2$', '', 'u6_warmup_6_1_3_diamond.png')
plt.close('all')
make_diamond('', '', r'$8$', r'$19$', 'u6_warmup_6_2_1_diamond.png')
plt.close('all')
make_diamond(r'$18$', r'$2$', '', '', 'u6_warmup_6_2_2_diamond.png')
plt.close('all')
make_diamond('', r'$-8$', '', r'$-5$', 'u6_warmup_6_2_3_diamond.png')
plt.close('all')
make_diamond('', r'$-5$', r'$-4$', '', 'u6_warmup_6_3_1_diamond.png')
plt.close('all')
make_diamond(r'$-84$', '', r'$7$', '', 'u6_warmup_6_3_2_diamond.png')
plt.close('all')
make_diamond(r'$42$', '', '', r'$13$', 'u6_warmup_6_3_3_diamond.png')
plt.close('all')
make_diamond('', '', r'$-4$', r'$5$', 'u6_warmup_6_4_1_diamond.png')
plt.close('all')
make_diamond('', r'$-11$', '', r'$-12$', 'u6_warmup_6_4_2_diamond.png')
plt.close('all')
make_diamond(r'$-80$', r'$-10$', '', '', 'u6_warmup_6_4_3_diamond.png')
plt.close('all')
make_diamond('', r'$5$', r'$7$', '', 'u6_warmup_6_5_1_diamond.png')
plt.close('all')
make_diamond(r'$-36$', '', r'$-3$', '', 'u6_warmup_6_5_2_diamond.png')
plt.close('all')
make_diamond('', '', r'$-9$', r'$-9$', 'u6_warmup_6_5_3_diamond.png')
plt.close('all')
