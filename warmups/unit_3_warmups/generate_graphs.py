...
# Unit 3 warmup generated diamonds
# Section 3.1 Day 1: V1+P1; factors 3 and 5
make_diamond('', '$3$', '$5$', '', filename='u3_warmup_3_1_1_diamond.png')
# Section 3.1 Day 2: V2+P2; factors 7 and -4
make_diamond('$-28$', '', '', '$3$', filename='u3_warmup_3_1_2_diamond.png')
# Section 3.1 Day 3: V3+P4; factors -2 and -9
make_diamond('$18$', '', '$-9$', '', filename='u3_warmup_3_1_3_diamond.png')
# Section 3.2 Day 1: V4+P6; factors 8 and 11
make_diamond('', '', '$11$', '$19$', filename='u3_warmup_3_2_1_diamond.png')
# Section 3.2 Day 2: V1+P3; factors 4 and 6
make_diamond('$24$', '$4$', '', '', filename='u3_warmup_3_2_2_diamond.png')
# Section 3.2 Day 3: V2+P5; factors 9 and -5
make_diamond('', '$9$', '', '$4$', filename='u3_warmup_3_2_3_diamond.png')
# Section 3.3 Day 1: V3+P1; factors -3 and -7
make_diamond('', '$-3$', '$-7$', '', filename='u3_warmup_3_3_1_diamond.png')
# Section 3.3 Day 2: V4+P4; factors -8 and 12
make_diamond('$-96$', '', '$12$', '', filename='u3_warmup_3_3_2_diamond.png')
# Section 3.3 Day 3: V1+P2; factors 7 and 8
make_diamond('$56$', '', '', '$15$', filename='u3_warmup_3_3_3_diamond.png')
# Section 3.4 Day 1: V2+P6; factors 10 and -3
make_diamond('', '', '$-3$', '$7$', filename='u3_warmup_3_4_1_diamond.png')
# Section 3.4 Day 2: V3+P5; factors -5 and -8
make_diamond('', '$-5$', '', '$-13$', filename='u3_warmup_3_4_2_diamond.png')
# Section 3.4 Day 3: V4+P3; factors 9 and 11
make_diamond('$99$', '$9$', '', '', filename='u3_warmup_3_4_3_diamond.png')
# Section 3.5 Day 1: V1+P1; factors 5 and 7
make_diamond('', '$5$', '$7$', '', filename='u3_warmup_3_5_1_diamond.png')
# Section 3.5 Day 2: V2+P4; factors 12 and -7
make_diamond('$-84$', '', '$-7$', '', filename='u3_warmup_3_5_2_diamond.png')
# Section 3.5 Day 3: V5+P6; factors 0 and -6
make_diamond('', '', '$-6$', '$-6$', filename='u3_warmup_3_5_3_diamond.png')
