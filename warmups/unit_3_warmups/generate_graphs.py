...
# Unit 2 bank figure generation (appended for warmups)
# ─────────────────────────────────────────────────────────────────────────────
...
# Unit 1 bank figure generation (appended for warmups)
# ─────────────────────────────────────────────────────────────────────────────
...
# Unit 3 warmup generated diamond figures
make_diamond('', '$3$', '$5$', '', filename='u3_warmup_3_1_1_diamond.png')  # V1 + P1; factors 3 and 5
make_diamond('$-24$', '', '', '$2$', filename='u3_warmup_3_1_2_diamond.png')  # V2 + P2; factors 6 and -4
make_diamond('$21$', '', '$-7$', '', filename='u3_warmup_3_1_3_diamond.png')  # V3 + P4; factors -3 and -7
make_diamond('', '', '$8$', '$17$', filename='u3_warmup_3_2_1_diamond.png')  # V4 + P6; factors 9 and 8
make_diamond('$28$', '$4$', '', '', filename='u3_warmup_3_2_2_diamond.png')  # V1 + P3; factors 4 and 7
make_diamond('', '$-9$', '', '$-7$', filename='u3_warmup_3_2_3_diamond.png')  # V2 + P5; factors -9 and 2
make_diamond('', '$-5$', '$-6$', '', filename='u3_warmup_3_3_1_diamond.png')  # V3 + P1; factors -5 and -6
make_diamond('$-84$', '', '$7$', '', filename='u3_warmup_3_3_2_diamond.png')  # V4 + P4; factors -12 and 7
make_diamond('$32$', '', '', '$12$', filename='u3_warmup_3_3_3_diamond.png')  # V1 + P2; factors 8 and 4
make_diamond('', '', '$-6$', '$5$', filename='u3_warmup_3_4_1_diamond.png')  # V2 + P6; factors 11 and -6
make_diamond('', '$-2$', '', '$-10$', filename='u3_warmup_3_4_2_diamond.png')  # V3 + P5; factors -2 and -8
make_diamond('$-90$', '$10$', '', '', filename='u3_warmup_3_4_3_diamond.png')  # V4 + P3; factors 10 and -9
make_diamond('', '$6$', '$7$', '', filename='u3_warmup_3_5_1_diamond.png')  # V1 + P1; factors 6 and 7
make_diamond('$-44$', '', '$4$', '', filename='u3_warmup_3_5_2_diamond.png')  # V2 + P4; factors -11 and 4
make_diamond('', '', '$9$', '$9$', filename='u3_warmup_3_5_3_diamond.png')  # V5 + P6; factors 0 and 9
