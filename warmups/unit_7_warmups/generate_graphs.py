...
# Unit 5 assessment-bank graph generation blocks (appended for warmup source figures)
# ─────────────────────────────────────────────────────────────────────────────
...
# Unit 7 warmup diamond generation blocks
make_diamond('', '$3$', '$4$', '', filename='u7_warmup_7_1_1_diamond.png')
make_diamond('$-24$', '', '', '$5$', filename='u7_warmup_7_1_2_diamond.png')
make_diamond('$14$', '', '$-7$', '', filename='u7_warmup_7_1_3_diamond.png')
make_diamond('', '', '$5$', '$17$', filename='u7_warmup_7_2_1_diamond.png')
make_diamond('$18$', '$2$', '', '', filename='u7_warmup_7_2_2_diamond.png')
make_diamond('', '$-4$', '', '$2$', filename='u7_warmup_7_2_3_diamond.png')
make_diamond('', '$-5$', '$-6$', '', filename='u7_warmup_7_3_1_diamond.png')
make_diamond('$-88$', '', '$-8$', '', filename='u7_warmup_7_3_2_diamond.png')
make_diamond('$56$', '', '', '$15$', filename='u7_warmup_7_3_3_diamond.png')
make_diamond('', '', '$2$', '$-7$', filename='u7_warmup_7_4_1_diamond.png')
make_diamond('', '$-1$', '', '$-11$', filename='u7_warmup_7_4_2_diamond.png')
make_diamond('$-84$', '$-12$', '', '', filename='u7_warmup_7_4_3_diamond.png')
make_diamond('', '$5$', '$6$', '', filename='u7_warmup_7_5_1_diamond.png')
make_diamond('$-44$', '', '$4$', '', filename='u7_warmup_7_5_2_diamond.png')
make_diamond('', '', '$9$', '$9$', filename='u7_warmup_7_5_3_diamond.png')
