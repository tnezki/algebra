...
# Unit 2 bank graph-generation blocks
# ─────────────────────────────────────────────────────────────────────────────
...
# Unit 1 bank graph-generation blocks
# ─────────────────────────────────────────────────────────────────────────────
...
# Unit 0B bank graph-generation blocks
# ─────────────────────────────────────────────────────────────────────────────
...
# Unit 2 warmup diamond graph-generation blocks
make_diamond('', '$3$', '$5$', '', 'u2_warmup_2_1_1_diamond.png')  # V1 + P1 factors 3 and 5
make_diamond('$-48$', '', '', '$-2$', 'u2_warmup_2_1_2_diamond.png')  # V2 + P2 factors 6 and -8
make_diamond('$21$', '', '$-7$', '', 'u2_warmup_2_1_3_diamond.png')  # V3 + P4 factors -3 and -7
make_diamond('', '', '$7$', '$18$', 'u2_warmup_2_2_1_diamond.png')  # V4 + P6 factors 11 and 7
make_diamond('$24$', '$4$', '', '', 'u2_warmup_2_2_2_diamond.png')  # V1 + P3 factors 4 and 6
make_diamond('', '$9$', '', '$5$', 'u2_warmup_2_2_3_diamond.png')  # V2 + P5 factors 9 and -4
make_diamond('', '$-4$', '$-5$', '', 'u2_warmup_2_3_1_diamond.png')  # V3 + P1 factors -4 and -5
make_diamond('$-72$', '', '$8$', '', 'u2_warmup_2_3_2_diamond.png')  # V4 + P4 factors -9 and 8
make_diamond('$18$', '', '', '$11$', 'u2_warmup_2_3_3_diamond.png')  # V1 + P2 factors 2 and 9
make_diamond('', '', '$-5$', '$7$', 'u2_warmup_2_4_1_diamond.png')  # V2 + P6 factors 12 and -5
make_diamond('', '$-2$', '', '$-11$', 'u2_warmup_2_4_2_diamond.png')  # V3 + P5 factors -2 and -9
make_diamond('$-96$', '$-12$', '', '', 'u2_warmup_2_4_3_diamond.png')  # V4 + P3 factors -12 and 8
make_diamond('', '$7$', '$8$', '', 'u2_warmup_2_5_1_diamond.png')  # V1 + P1 factors 7 and 8
make_diamond('$-21$', '', '$-3$', '', 'u2_warmup_2_5_2_diamond.png')  # V2 + P4 factors 7 and -3
make_diamond('', '', '$-7$', '$-7$', 'u2_warmup_2_5_3_diamond.png')  # V5 + P6 factors 0 and -7
