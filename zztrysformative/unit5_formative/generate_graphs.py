...
# Unit 5 formative graph-generation blocks appended below the existing source.

# u5_f_dok1_2_v1_diamond.png
make_diamond(r'$-24$', '', '', r'$2$', 'u5_f_dok1_2_v1_diamond.png')
plt.close('all')


# u5_f_dok1_2_v2_diamond.png
make_diamond(r'$-18$', '', '', r'$3$', 'u5_f_dok1_2_v2_diamond.png')
plt.close('all')


# u5_f_dok1_2_v3_diamond.png
make_diamond(r'$20$', '', '', r'$-9$', 'u5_f_dok1_2_v3_diamond.png')
plt.close('all')


# u5_f_dok1_2_v4_diamond.png
make_diamond(r'$36$', '', '', r'$12$', 'u5_f_dok1_2_v4_diamond.png')
plt.close('all')


# u5_f_dok1_2_v7_area.png
make_rectangle_model([r'$x$', r'$5$'], [r'$x$', r'$2$'], [[r'$x^2$', r'$2x$'], [r'$5x$', r'$10$']], 'u5_f_dok1_2_v7_area.png')
plt.close('all')


# u5_f_dok1_2_v8_area.png
make_rectangle_model([r'$x$', r'$3$'], [r'$x$', r'$6$'], [[r'$x^2$', r'$6x$'], [r'$3x$', r'$18$']], 'u5_f_dok1_2_v8_area.png')
plt.close('all')


# u5_f_dok1_4_v5_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-2)**2 - 5, 'deriv':lambda x: 2*(x-2), 'color':'steelblue'}], title='')
save_graph(fig, 'u5_f_dok1_4_v5_graph.png')
plt.close(fig)


# u5_f_dok1_4_v6_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: -(x+1)**2 + 4, 'deriv':lambda x: -2*(x+1), 'color':'steelblue'}], title='')
save_graph(fig, 'u5_f_dok1_4_v6_graph.png')
plt.close(fig)


# u5_f_dok2_1_v1_area.png
make_rectangle_model([r'$3x$', r'$2$'], [r'$x$', r'$5$'], [[r'$3x^2$', ''], ['', r'$10$']], 'u5_f_dok2_1_v1_area.png')
plt.close('all')


# u5_f_dok2_1_v2_area.png
make_rectangle_model([r'$4x$', r'$3$'], [r'$x$', r'$2$'], [[r'$4x^2$', ''], ['', r'$6$']], 'u5_f_dok2_1_v2_area.png')
plt.close('all')


# u5_f_dok2_1_v3_area.png
make_rectangle_model([r'$2x$', r'$5$'], [r'$x$', r'$4$'], [[r'$2x^2$', ''], ['', r'$20$']], 'u5_f_dok2_1_v3_area.png')
plt.close('all')


# u5_f_dok2_1_v4_area.png
make_rectangle_model([r'$5x$', r'$1$'], [r'$x$', r'$3$'], [[r'$5x^2$', ''], ['', r'$3$']], 'u5_f_dok2_1_v4_area.png')
plt.close('all')


# u5_f_dok2_2_v7_area.png
make_rectangle_model([r'$x$', r'$2$'], [r'$x$', r'$5$'], [[r'$x^2$', r'$5x$'], [r'$2x$', r'$10$']], 'u5_f_dok2_2_v7_area.png')
plt.close('all')


# u5_f_dok2_2_v8_area.png
make_rectangle_model([r'$x$', r'$3$'], [r'$x$', r'$4$'], [[r'$x^2$', r'$4x$'], [r'$3x$', r'$12$']], 'u5_f_dok2_2_v8_area.png')
plt.close('all')


# u5_f_dok2_3_v7_area.png
make_rectangle_model([r'$x$', r'$4$'], [r'$x$', r'$-4$'], [[r'$x^2$', r'$-4x$'], [r'$4x$', r'$-16$']], 'u5_f_dok2_3_v7_area.png')
plt.close('all')


# u5_f_dok2_3_v8_area.png
make_rectangle_model([r'$x$', r'$5$'], [r'$x$', r'$-5$'], [[r'$x^2$', r'$-5x$'], [r'$5x$', r'$-25$']], 'u5_f_dok2_3_v8_area.png')
plt.close('all')


# u5_f_dok2_4_v1_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda t: -1*t*(t-6), 'deriv':lambda t: -2*t + 6, 'color':'steelblue'}], 0, 7, 0, 12, xlabel='Time (s)', ylabel='Height (ft)', title='')
save_graph(fig, 'u5_f_dok2_4_v1_graph.png')
plt.close(fig)


# u5_f_dok2_4_v2_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda t: -1*t*(t-5), 'deriv':lambda t: -2*t + 5, 'color':'steelblue'}], 0, 6, 0, 8, xlabel='Time (s)', ylabel='Height (ft)', title='')
save_graph(fig, 'u5_f_dok2_4_v2_graph.png')
plt.close(fig)


# u5_f_dok2_4_v3_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda t: -0.5*t*(t-8), 'deriv':lambda t: -t + 4, 'color':'steelblue'}], 0, 9, 0, 10, xlabel='Time (s)', ylabel='Height (ft)', title='')
save_graph(fig, 'u5_f_dok2_4_v3_graph.png')
plt.close(fig)


# u5_f_dok2_4_v4_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda t: -0.75*t*(t-4), 'deriv':lambda t: -1.5*t + 3, 'color':'steelblue'}], 0, 5, 0, 5, xlabel='Time (s)', ylabel='Height (ft)', title='')
save_graph(fig, 'u5_f_dok2_4_v4_graph.png')
plt.close(fig)


# u5_f_dok2_4_v7_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-1)*(x-5), 'deriv':lambda x: 2*x-6, 'color':'steelblue'}], title='')
save_graph(fig, 'u5_f_dok2_4_v7_graph.png')
plt.close(fig)


# u5_f_dok2_4_v8_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x+2)*(x-4), 'deriv':lambda x: 2*x-2, 'color':'steelblue'}], title='')
save_graph(fig, 'u5_f_dok2_4_v8_graph.png')
plt.close(fig)


# u5_f_dok3_1_v5_area.png
make_rectangle_model([r'$2x$', r'$3$'], [r'$x$', r'$-4$'], [[r'$2x^2$', r'$-8x$'], [r'$3x$', r'$-12$']], 'u5_f_dok3_1_v5_area.png')
plt.close('all')


# u5_f_dok3_1_v6_area.png
make_rectangle_model([r'$3x$', r'$2$'], [r'$x$', r'$-5$'], [[r'$3x^2$', r'$-15x$'], [r'$2x$', r'$-10$']], 'u5_f_dok3_1_v6_area.png')
plt.close('all')


# u5_f_dok3_3_v5_area.png
make_rectangle_model([r'$x$', r'$6$'], [r'$x$', r'$4$'], [[r'$x^2$', r'$4x$'], [r'$6x$', r'$24$']], 'u5_f_dok3_3_v5_area.png')
plt.close('all')


# u5_f_dok3_3_v6_area.png
make_rectangle_model([r'$x$', r'$7$'], [r'$x$', r'$5$'], [[r'$x^2$', r'$5x$'], [r'$7x$', r'$35$']], 'u5_f_dok3_3_v6_area.png')
plt.close('all')


# u5_f_dok3_4_v5_compare.png
fig = make_2x1_grid([
    [{'expr':lambda x: (x+3)*(x-1), 'deriv':lambda x: 2*x+2, 'color':'steelblue'}],
    [{'expr':lambda x: -(x-3)*(x+1), 'deriv':lambda x: -2*x+2, 'color':'firebrick'}]
], titles=[r'$A$', r'$B$'])
save_graph(fig, 'u5_f_dok3_4_v5_compare.png')
plt.close(fig)


# u5_f_dok3_4_v6_compare.png
fig = make_2x1_grid([
    [{'expr':lambda x: (x+2)*(x-4), 'deriv':lambda x: 2*x-2, 'color':'steelblue'}],
    [{'expr':lambda x: -(x-5)*(x-1), 'deriv':lambda x: -2*x+6, 'color':'firebrick'}]
], titles=[r'$A$', r'$B$'])
save_graph(fig, 'u5_f_dok3_4_v6_compare.png')
plt.close(fig)


# u5_f_dok4_1_v1_area.png
make_rectangle_model([r'$5m$', r'$2$'], [r'$m$', r'$-3$'], [[r'$5m^2$', r'$-15m$'], [r'$2m$', r'$-6$']], 'u5_f_dok4_1_v1_area.png')
plt.close('all')


# u5_f_dok4_1_v2_area.png
make_rectangle_model([r'$4p$', r'$3$'], [r'$p$', r'$-2$'], [[r'$4p^2$', r'$-8p$'], [r'$3p$', r'$-6$']], 'u5_f_dok4_1_v2_area.png')
plt.close('all')


# u5_f_dok4_1_v3_area.png
make_rectangle_model([r'$3x$', r'$5$'], [r'$x$', r'$-4$'], [[r'$3x^2$', r'$-12x$'], [r'$5x$', r'$-20$']], 'u5_f_dok4_1_v3_area.png')
plt.close('all')


# u5_f_dok4_1_v4_area.png
make_rectangle_model([r'$6n$', r'$1$'], [r'$n$', r'$-2$'], [[r'$6n^2$', r'$-12n$'], [r'$n$', r'$-2$']], 'u5_f_dok4_1_v4_area.png')
plt.close('all')


# u5_f_dok4_4_v1_blank.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [], title='')
save_graph(fig, 'u5_f_dok4_4_v1_blank.png')
plt.close(fig)


# u5_f_dok4_4_v2_blank.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [], title='')
save_graph(fig, 'u5_f_dok4_4_v2_blank.png')
plt.close(fig)


# u5_f_dok4_4_v3_blank.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [], title='')
save_graph(fig, 'u5_f_dok4_4_v3_blank.png')
plt.close(fig)


# u5_f_dok4_4_v4_blank.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [], title='')
save_graph(fig, 'u5_f_dok4_4_v4_blank.png')
plt.close(fig)
