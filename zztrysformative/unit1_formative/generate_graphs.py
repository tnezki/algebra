...
# Auto-generated Unit 1 formative graph blocks appended below the uploaded graph code.

# Unit 1 DOK 1.2 intercept graphs
for filename, m, b in [
    ('u1_dok1_2_v1_intercepts.png', 2, -4),
    ('u1_dok1_2_v2_intercepts.png', -1, 3),
    ('u1_dok1_2_v3_intercepts.png', 3, 6),
    ('u1_dok1_2_v4_intercepts.png', -2, -6),
]:
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    fig.patch.set_facecolor('white')
...
# Unit 1 DOK 1.2 context starting-value graphs
for filename, m, b, ymax in [
    ('u1_dok1_2_v5_context.png', 4, 12, 50),
    ('u1_dok1_2_v6_context.png', 6, 8, 60),
]:
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    fig.patch.set_facecolor('white')
