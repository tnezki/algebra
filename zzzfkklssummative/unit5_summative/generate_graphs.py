...
# Unit 5 summative version-specific figure blocks appended below the final marker.

# u5_sum_t5_area_v1.png
make_rectangle_model([r'$2x$', r'$3$'], [r'$x$', r'$4$'], [[r'$2x^2$', ''], ['', r'$12$']], 'u5_sum_t5_area_v1.png')
plt.close('all')

# u5_sum_t5_area_v2.png
make_rectangle_model([r'$3x$', r'$5$'], [r'$x$', r'$2$'], [[r'$3x^2$', ''], ['', r'$10$']], 'u5_sum_t5_area_v2.png')
plt.close('all')

# u5_sum_t5_area_v3.png
make_rectangle_model([r'$4x$', r'$-1$'], [r'$x$', r'$3$'], [[r'$4x^2$', ''], ['', r'$-3$']], 'u5_sum_t5_area_v3.png')
plt.close('all')

# u5_sum_t5_area_v4.png
make_rectangle_model([r'$2x$', r'$-5$'], [r'$x$', r'$6$'], [[r'$2x^2$', ''], ['', r'$-30$']], 'u5_sum_t5_area_v4.png')
plt.close('all')

# u5_sum_t5_area_v5.png
make_rectangle_model([r'$5x$', r'$2$'], [r'$x$', r'$-3$'], [[r'$5x^2$', ''], ['', r'$-6$']], 'u5_sum_t5_area_v5.png')
plt.close('all')

# u5_sum_t5_area_v6.png
make_rectangle_model([r'$3x$', r'$-4$'], [r'$x$', r'$5$'], [[r'$3x^2$', ''], ['', r'$-20$']], 'u5_sum_t5_area_v6.png')
plt.close('all')

# u5_sum_t5_area_v7.png
make_rectangle_model([r'$6x$', r'$1$'], [r'$x$', r'$-2$'], [[r'$6x^2$', ''], ['', r'$-2$']], 'u5_sum_t5_area_v7.png')
plt.close('all')

# u5_sum_t5_area_v8.png
make_rectangle_model([r'$4x$', r'$-3$'], [r'$x$', r'$4$'], [[r'$4x^2$', ''], ['', r'$-12$']], 'u5_sum_t5_area_v8.png')
plt.close('all')
