...
_notes_ineq('u3_bank_s4_wrong_boundary_sq_v1.png', [
    {'expr': lambda x: -1*x + 4, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'darkorange', 'shade': 'above', 'inclusive': True},
])
_notes_ineq('u3_s4_mn1_boundary.png', [
    {'expr': lambda x: x - 2, 'deriv': lambda x: np.full_like(x, 1.0), 'color': 'steelblue', 'shade': 'above', 'inclusive': True},
])
_notes_ineq('u3_s4_mn2_test_point.png', [
    {'expr': lambda x: -2*x + 4, 'deriv': lambda x: np.full_like(x, -2.0), 'color': 'firebrick', 'shade': 'below', 'inclusive': False},
], [(0, 0, '(0,0)')])
