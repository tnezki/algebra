...
_notes_standard('u3_s1_mn1_intersection.png', [
    {'expr': lambda x: x + 1, 'deriv': lambda x: np.full_like(x, 1.0), 'color': 'steelblue', 'label': 'A'},
    {'expr': lambda x: -x + 7, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'firebrick', 'label': 'B'},
], [(3, 4, '(3,4)')])
_notes_standard('u3_s1_mn2_same_axes.png', [
    {'expr': lambda x: 2*x - 3, 'deriv': lambda x: np.full_like(x, 2.0), 'color': 'steelblue', 'label': 'A'},
    {'expr': lambda x: -x + 6, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'firebrick', 'label': 'B'},
], [(3, 3, '(3,3)')])
_notes_standard('u3_s1_mn4_elimination.png', [
    {'expr': lambda x: -2*x + 10, 'deriv': lambda x: np.full_like(x, -2.0), 'color': 'steelblue', 'label': 'A'},
    {'expr': lambda x: (2/3)*x + 2, 'deriv': lambda x: np.full_like(x, 2/3), 'color': 'firebrick', 'label': 'B'},
], [(3, 4, '(3,4)')])
