...
# Appended Unit 2 notes graph-generation blocks — Section 2.5
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1,2,3,4,5,6], [52,57,63,70,74,81], 0, 7, 45, 90, color='steelblue', point_size=35, line_of_best_fit=False, xlabel='Practice time', ylabel='Score', title='')
save_graph(fig, 'u2_notes_s5_scatter_association.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1,2,3,4,5,6], [55,61,67,71,79,84], 0, 8, 45, 100, color='steelblue', point_size=35, line_of_best_fit=True, xlabel='Study hours', ylabel='Score', title='')
save_graph(fig, 'u2_notes_s5_line_fit.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [2,4,6,8,10], [16,29,41,52,66], 0, 12, 0, 80, color='darkorange', point_size=35, line_of_best_fit=True, xlabel='Minutes', ylabel='Calories', title='')
save_graph(fig, 'u2_notes_s5_model_points.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1,2,3,4,5,6,7,8], [31,34,38,42,45,49,52,56], 0, 10, 25, 65, color='steelblue', point_size=35, line_of_best_fit=True, xlabel='Input', ylabel='Output', title='')
save_graph(fig, 'u2_notes_s5_reasonable.png')
plt.close(fig)
