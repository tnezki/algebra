...
make_context_graph(ax, [_exp(60,1.5,'steelblue','model')], 0, 4, 0, 220, xlabel='Time', ylabel='Data', title='')
ax.scatter([0,1,2,3],[60,90,135,202.5], color='firebrick', s=30, zorder=5)
save_graph(fig, 'u7_s5_data_model.png'); plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax, [_exp(400,0.71,'steelblue','model')], 0, 4, 0, 420, xlabel='Hour', ylabel='Amount', title='')
ax.scatter([0,1,2,3,4],[400,284,205,142,104], color='firebrick', s=30, zorder=5)
save_graph(fig, 'u7_s5_imperfect_decay.png'); plt.close(fig)
