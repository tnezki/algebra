...
_notes_context('u3_s3_mn1_constraints.png', [
    {'expr': lambda x: 100 - x, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'steelblue', 'label': 'tickets'},
    {'expr': lambda x: 80 - (2/3)*x, 'deriv': lambda x: np.full_like(x, -2/3), 'color': 'firebrick', 'label': 'revenue'},
], 0, 100, 0, 110, 'Student tickets', 'Adult tickets', [(60, 40, '(60,40)')])
_notes_context('u3_s3_mn2_solution_meaning.png', [
    {'expr': lambda x: 50 + 5*x, 'deriv': lambda x: np.full_like(x, 5.0), 'color': 'steelblue', 'label': 'A'},
    {'expr': lambda x: 20 + 8*x, 'deriv': lambda x: np.full_like(x, 8.0), 'color': 'firebrick', 'label': 'B'},
], 0, 20, 0, 180, 'Uses', 'Cost', [(10, 100, '(10,100)')])
_notes_context('u3_s3_mn3_cost_compare.png', [
    {'expr': lambda x: 50 + 5*x, 'deriv': lambda x: np.full_like(x, 5.0), 'color': 'steelblue', 'label': 'A'},
    {'expr': lambda x: 20 + 8*x, 'deriv': lambda x: np.full_like(x, 8.0), 'color': 'firebrick', 'label': 'B'},
], 0, 20, 0, 180, 'Uses', 'Cost', [(10, 100, '(10,100)')])
