...
# Appended Unit 5 notes graph-generation blocks
make_rectangle_model([r'$6x$'], [r'$2x$', r'$-3$'], [[r'$12x^2$', r'$-18x$']], filename='u5_s1_mn1_gcf_area.png')
make_rectangle_model([r'$4x$'], [r'$x$', r'$5$'], [[r'$4x^2$', r'$20x$']], filename='u5_s1_mn2_area_product.png')
make_rectangle_model([r'$9x$'], [r'$2x$', r'$3$'], [[r'$18x^2$', r'$27x$']], filename='u5_s1_mn4_complete_factor.png')
make_diamond(r'$12$', r'$3$', r'$4$', r'$7$', filename='u5_s2_mn1_diamond.png')
make_rectangle_model([r'$x$', r'$3$'], [r'$x$', r'$5$'], [[r'$x^2$', r'$5x$'], [r'$3x$', r'$15$']], filename='u5_s2_mn2_trinomial_area.png')
make_rectangle_model([r'$2x$', r'$-3$'], [r'$x$', r'$4$'], [[r'$2x^2$', r'$8x$'], [r'$-3x$', r'$-12$']], filename='u5_s2_mn3_split_middle.png')
make_rectangle_model([r'$x$', r'$4$'], [r'$x$', r'$4$'], [[r'$x^2$', r'$4x$'], [r'$4x$', r'$16$']], filename='u5_s3_mn1_square_pattern.png')
make_rectangle_model([r'$x$', r'$-5$'], [r'$x$', r'$5$'], [[r'$x^2$', r'$5x$'], [r'$-5x$', r'$-25$']], filename='u5_s3_mn2_difference_squares.png')
make_rectangle_model([r'$x$', r'$2$'], [r'$x$', r'$7$'], [[r'$x^2$', r'$7x$'], [r'$2x$', r'$14$']], filename='u5_s3_mn3_nonexample.png')

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: (x+3)*(x-2), 'deriv': lambda x: 2*x+1, 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u5_s4_mn1_zeros_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: (x-1)*(x-5), 'deriv': lambda x: 2*x-6, 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u5_s4_mn2_factored_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: -x*(x-6), 'deriv': lambda x: -2*x+6, 'color':'steelblue', 'label':None}], 0, 6, 0, 10, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u5_s4_mn4_context_height.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x*x-4*x-5, 'deriv': lambda x: 2*x-4, 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u5_s5_mn1_forms_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: -(x-2)**2+8, 'deriv': lambda x: -2*(x-2), 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u5_s5_mn2_vertex_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: -x*(x-6), 'deriv': lambda x: -2*x+6, 'color':'steelblue', 'label':None}], 0, 6, 0, 10, xlabel='Input', ylabel='Output', title='')
save_graph(fig, 'u5_s5_mn4_form_choice.png')
plt.close(fig)
