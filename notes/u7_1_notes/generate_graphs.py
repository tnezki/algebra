...
make_standard_graph(ax, [_line(3,4,'firebrick','add +3'), _exp(3,2,'steelblue','multiply ×2')], title='')
save_graph(fig, 'u7_s1_growth_decay_compare.png'); plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax, [_exp(12,1.5,'steelblue','ratio 1.5')], 0, 4, 0, 70, xlabel='Day', ylabel='Views', title='')
ax.scatter([0,1,2,3,4],[12,18,27,40.5,60.75], color='firebrick', s=28, zorder=5)
save_graph(fig, 'u7_s1_constant_ratio_graph.png'); plt.close(fig)
