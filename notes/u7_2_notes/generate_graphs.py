...
make_context_graph(ax, [_exp(40,1.25,'steelblue','model')], 0, 6, 0, 160, xlabel='Step', ylabel='Amount', title='')
ax.scatter([0],[40], color='firebrick', s=36, zorder=5)
save_graph(fig, 'u7_s2_initial_multiplier.png'); plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_context_graph(ax, [_exp(300,0.88,'steelblue','value')], 0, 6, 0, 320, xlabel='Years', ylabel='Value', title='')
ax.scatter([4],[300*(0.88**4)], color='firebrick', s=36, zorder=5)
save_graph(fig, 'u7_s2_percent_model.png'); plt.close(fig)
