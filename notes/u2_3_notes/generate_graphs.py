...
# Appended Unit 2 notes graph-generation blocks
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [-2, 4], [1, 7], -4, 6, -1, 9, color='steelblue', point_size=60, line_of_best_fit=True, xlabel='Input', ylabel='Output', title='')
save_graph(fig, 'u2_s1_mn1_slope_points.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: 3*x + 5, 'deriv': lambda x: np.zeros_like(x)+3, 'color':'steelblue', 'label':None}], 0, 6, 0, 25, xlabel='Miles', ylabel='Cost', title='')
save_graph(fig, 'u2_s1_mn2_context_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [-2,4,6], [1,10,13], -4, 8, -1, 15, color='steelblue', point_size=60, line_of_best_fit=True, xlabel='x', ylabel='y', title='')
save_graph(fig, 'u2_s1_mn3_compare_slopes.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: 2*x + 1, 'deriv': lambda x: np.zeros_like(x)+2, 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u2_s2_mn1_slope_intercept.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: 0.5*x - 3, 'deriv': lambda x: np.zeros_like(x)+0.5, 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u2_s2_mn2_graph_steps.png')
plt.close(fig)

fig = make_2x2_grid([
    [{'expr': lambda x: x+2, 'deriv': lambda x: np.zeros_like(x)+1, 'color':'steelblue', 'label':None}],
    [{'expr': lambda x: -2*x+1, 'deriv': lambda x: np.zeros_like(x)-2, 'color':'firebrick', 'label':None}],
    [{'expr': lambda x: 2*x-2, 'deriv': lambda x: np.zeros_like(x)+2, 'color':'darkorange', 'label':None}],
    [{'expr': lambda x: 2*x+3, 'deriv': lambda x: np.zeros_like(x)+2, 'color':'steelblue', 'label':None}],
], titles=['A','B','C','D'])
save_graph(fig, 'u2_s2_mn3_matching_lines.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [0,1,2,3], [2,5,7,11], -1, 4, 0, 12, color='darkorange', point_size=55, line_of_best_fit=False, xlabel='x', ylabel='y', title='')
make_context_graph(ax, [{'expr': lambda x: 3*x + 2, 'deriv': lambda x: np.zeros_like(x)+3, 'color':'steelblue', 'label':None}], -1, 4, 0, 14, xlabel='x', ylabel='y', title='')
save_graph(fig, 'u2_s2_mn4_table_check.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: -3*x + 6, 'deriv': lambda x: np.zeros_like(x)-3, 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u2_s3_mn1_parts.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: 1.5*x + 1, 'deriv': lambda x: np.zeros_like(x)+1.5, 'color':'steelblue', 'label':None}], title='')
save_graph(fig, 'u2_s3_mn2_from_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [0,2,4,6], [5,11,17,23], 0, 7, 0, 25, color='steelblue', point_size=55, line_of_best_fit=True, xlabel='x', ylabel='y', title='')
save_graph(fig, 'u2_s3_mn3_from_table.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [
    {'expr': lambda x: 4*x + 3, 'deriv': lambda x: np.zeros_like(x)+4, 'color':'steelblue', 'label':r'$A$'},
    {'expr': lambda x: -6*x + 36, 'deriv': lambda x: np.zeros_like(x)-6, 'color':'firebrick', 'label':r'$B$'},
], 0, 6, 0, 40, xlabel='Input', ylabel='Output', title='')
save_graph(fig, 'u2_s4_mn1_slope_magnitude.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [
    {'expr': lambda x: 4*x + 15, 'deriv': lambda x: np.zeros_like(x)+4, 'color':'steelblue', 'label':r'$A$'},
    {'expr': lambda x: 7*x + 3, 'deriv': lambda x: np.zeros_like(x)+7, 'color':'firebrick', 'label':r'$B$'},
], 0, 8, 0, 65, xlabel='Uses', ylabel='Cost', title='')
save_graph(fig, 'u2_s4_mn2_common_features.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [0,2,4,6], [8,10,12,14], 0, 7, 0, 25, color='darkorange', point_size=55, line_of_best_fit=True, xlabel='x', ylabel='y', title='')
save_graph(fig, 'u2_s4_mn3_table_compare.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1,2,3,4,5], [8,11,15,18,22], 0, 6, 0, 25, color='steelblue', point_size=55, line_of_best_fit=True, xlabel='Practice time', ylabel='Score', title='')
save_graph(fig, 'u2_s5_mn1_association.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1,3,5,7], [23,29,35,41], 0, 10, 15, 55, color='steelblue', point_size=55, line_of_best_fit=True, xlabel='Week', ylabel='Height', title='')
save_graph(fig, 'u2_s5_mn2_line_fit.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [2,4,6,8,10], [15,22,29,35,43], 0, 12, 0, 55, color='steelblue', point_size=55, line_of_best_fit=True, xlabel='Minutes', ylabel='Cost', title='')
save_graph(fig, 'u2_s5_mn3_table_model.png')
plt.close(fig)
