...
# Unit 4 notes graph-generation blocks appended below the authorized marker.
...
for _x, _y in [(2, -4), (0, 0), (4, 0)]:
    ax.plot(_x, _y, 'o', markersize=7, markerfacecolor='white', markeredgecolor='firebrick', markeredgewidth=2, zorder=6)
save_graph(fig, 'u4_s5_mn_vertex_form.png')
plt.close(fig)
...
for _x, _y in [(-3, 0), (1, 0), (-1, -4)]:
    ax.plot(_x, _y, 'o', markersize=7, markerfacecolor='white', markeredgecolor='firebrick', markeredgewidth=2, zorder=6)
save_graph(fig, 'u4_s5_mn_factored_form.png')
plt.close(fig)


fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: (x+1)**2 - 9, 'deriv': lambda x: 2*(x+1), 'color': 'steelblue'}], title='')
for _x, _y in [(-4, 0), (2, 0), (-1, -9)]:
    ax.plot(_x, _y, 'o', markersize=7, markerfacecolor='white', markeredgecolor='firebrick', markeredgewidth=2, zorder=6)
save_graph(fig, 'u4_s5_ex_feature_graph.png')
plt.close(fig)

_two_grid('u4_s5_ex_compare_forms.png', [[{'expr': lambda x: (x-4)*(x+2), 'deriv': lambda x: 2*x-2, 'color': 'steelblue'}], [{'expr': lambda x: -0.5*(x-1)**2+5, 'deriv': lambda x: -(x-1), 'color': 'firebrick'}]], titles=[r'$A$', r'$B$'])


fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: (x-4)*(x+8), 'deriv': lambda x: 2*x+4, 'color': 'steelblue'}], title='')
for _x, _y in [(-8, 0), (4, 0), (-2, -36)]:
    ax.plot(_x, _y, 'o', markersize=7, markerfacecolor='white', markeredgecolor='firebrick', markeredgewidth=2, zorder=6)
save_graph(fig, 'u4_s5_mn_axis_methods.png')
plt.close(fig)

_std_fig('u4_bank_s5_quadratic_feature_sq_v1.png', [{'expr': lambda x: (x-2)**2 - 4, 'deriv': lambda x: 2*(x-2), 'color': 'steelblue'}], title='')
