...
def _ctx(fn, filename, points=None, xmax=10, ymax=80, xlabel='x', ylabel='y'):
    ...
    save_graph(fig, filename)
    plt.close(fig)
_ctx([{'expr':lambda x: -4*(x-5)**2+60, 'deriv':lambda x: -8*(x-5), 'color':'steelblue', 'label':None}], 'u6_bank_s2_dok4_1_sq_v1.png', xmax=10, ymax=70)

make_rectangle_model([r'$x$', r'$4$'], [r'$x$', r'$4$'], [[r'$x^2$', r'$4x$'], [r'$4x$', r'$16$']], 'u6_s2_mn1_square_area.png')
_std([{'expr':lambda x: (x-3)**2-4, 'deriv':lambda x: 2*(x-3), 'color':'steelblue', 'label':None}], 'u6_s2_mn2_vertex_graph.png', [(3,-4),(1,0),(5,0)])
_std([{'expr':lambda x: (x-4)**2-6, 'deriv':lambda x: 2*(x-4), 'color':'steelblue', 'label':None}], 'u6_s2_mn3_vertex_symmetry.png', [(4,-6),(3,-5),(5,-5)])
