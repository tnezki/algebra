...
_notes_standard('u3_s2_mn1_substitution.png', [
    {'expr': lambda x: x + 2, 'deriv': lambda x: np.full_like(x, 1.0), 'color': 'steelblue', 'label': 'y=x+2'},
    {'expr': lambda x: -3*x + 14, 'deriv': lambda x: np.full_like(x, -3.0), 'color': 'firebrick', 'label': '3x+y=14'},
], [(3, 5, '(3,5)')])
_notes_standard('u3_s2_mn2_one_variable.png', [
    {'expr': lambda x: 2*x - 3, 'deriv': lambda x: np.full_like(x, 2.0), 'color': 'steelblue', 'label': 'A'},
    {'expr': lambda x: -x + 9, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'firebrick', 'label': 'B'},
], [(4, 5, '(4,5)')])
_notes_standard('u3_s2_mn4_efficiency.png', [
    {'expr': lambda x: -x + 8, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'steelblue', 'label': 'y=-x+8'},
    {'expr': lambda x: -4*x + 17, 'deriv': lambda x: np.full_like(x, -4.0), 'color': 'firebrick', 'label': '4x+y=17'},
], [(3, 5, '(3,5)')])
