...
def _ctx(fn, filename, points=None, xmax=10, ymax=80, xlabel='x', ylabel='y'):
    ...
    save_graph(fig, filename)
    plt.close(fig)
_ctx([{'expr':lambda x: -4*(x-5)**2+60, 'deriv':lambda x: -8*(x-5), 'color':'steelblue', 'label':None}], 'u6_bank_s1_dok4_1_sq_v1.png', xmax=10, ymax=70)

_std([{'expr':lambda x: (x-2)*(x-5), 'deriv':lambda x: 2*x-7, 'color':'steelblue', 'label':None}], 'u6_s1_mn1_zeros.png', [(2,0),(5,0)])
_std([{'expr':lambda x: x**2-7*x+10, 'deriv':lambda x: 2*x-7, 'color':'steelblue', 'label':None}], 'u6_s1_mn2_standard_factored.png', [(2,0),(5,0)])
_ctx([{'expr':lambda x: -4*(x-1)*(x-6), 'deriv':lambda x: -8*x+28, 'color':'steelblue', 'label':None}], 'u6_s1_mn3_context.png', [(1,0),(6,0),(3.5,25)], xmax=7, ymax=30, xlabel='Time', ylabel='Height')
