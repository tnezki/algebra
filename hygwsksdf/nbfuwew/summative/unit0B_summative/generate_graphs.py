...
# Auto-generated Unit 0B summative graph blocks appended below the required marker.

# u0b_summ_s3_rate_v1.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: 3*x + 2, 'deriv': lambda x: 0*x + 3, 'color': 'steelblue'}], 0, 8, 0, 30, xlabel='Figure number', ylabel='Tiles', title='')
save_graph(fig, 'u0b_summ_s3_rate_v1.png')
plt.close(fig)

# u0b_summ_s3_rate_v2.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: 2*x + 4, 'deriv': lambda x: 0*x + 2, 'color': 'steelblue'}], 0, 8, 0, 25, xlabel='Figure number', ylabel='Tiles', title='')
save_graph(fig, 'u0b_summ_s3_rate_v2.png')
plt.close(fig)

# u0b_summ_s3_rate_v3.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: 5*x + 1, 'deriv': lambda x: 0*x + 5, 'color': 'steelblue'}], 0, 6, 0, 35, xlabel='Figure number', ylabel='Tiles', title='')
save_graph(fig, 'u0b_summ_s3_rate_v3.png')
plt.close(fig)

# u0b_summ_s3_rate_v4.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: 4*x + 3, 'deriv': lambda x: 0*x + 4, 'color': 'steelblue'}], 0, 7, 0, 35, xlabel='Figure number', ylabel='Tiles', title='')
save_graph(fig, 'u0b_summ_s3_rate_v4.png')
plt.close(fig)

# u0b_summ_s4_line_v1.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: 2*x - 3, 'deriv': lambda x: 0*x + 2, 'color': 'steelblue'}], title='')
save_graph(fig, 'u0b_summ_s4_line_v1.png')
plt.close(fig)

# u0b_summ_s4_line_v2.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: -1*x + 4, 'deriv': lambda x: 0*x + -1, 'color': 'steelblue'}], title='')
save_graph(fig, 'u0b_summ_s4_line_v2.png')
plt.close(fig)

# u0b_summ_s4_line_v3.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: 3*x + 1, 'deriv': lambda x: 0*x + 3, 'color': 'steelblue'}], title='')
save_graph(fig, 'u0b_summ_s4_line_v3.png')
plt.close(fig)

# u0b_summ_s4_line_v4.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: -2*x + 6, 'deriv': lambda x: 0*x + -2, 'color': 'steelblue'}], title='')
save_graph(fig, 'u0b_summ_s4_line_v4.png')
plt.close(fig)
