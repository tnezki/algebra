...
# Unit 6 summative version-specific figure blocks appended below the final marker.

def _u6_save_standard_quadratic(filename, a, b, c):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    make_standard_graph(ax, [{
        'expr': lambda x, a=a, b=b, c=c: a*x**2 + b*x + c,
        'deriv': lambda x, a=a, b=b: 2*a*x + b,
        'color': 'steelblue',
        'label': None,
    }], title='')
    save_graph(fig, filename)
...
# Method-selection / graph-estimate figures for Target 7.
_u6_save_standard_quadratic('u6_sum_t7_method_v1.png', 1, -10, 24)
_u6_save_standard_quadratic('u6_sum_t7_method_v2.png', 1, -8, 15)
_u6_save_standard_quadratic('u6_sum_t7_method_v3.png', 1, -6, 8)
_u6_save_standard_quadratic('u6_sum_t7_method_v4.png', 1, -12, 35)
_u6_save_standard_quadratic('u6_sum_t7_method_v5.png', 1, 2, -15)
_u6_save_standard_quadratic('u6_sum_t7_method_v6.png', 1, -1, -20)
_u6_save_standard_quadratic('u6_sum_t7_method_v7.png', 2, 9, -5)
_u6_save_standard_quadratic('u6_sum_t7_method_v8.png', 3, -10, -8)


def _u6_save_height_graph(filename, k, neg_root, pos_root, xmax, ymax):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    make_context_graph(ax, [{
        'expr': lambda t, k=k, n=neg_root, p=pos_root: -k*(t-n)*(t-p),
        'deriv': lambda t, k=k, n=neg_root, p=pos_root: -k*(2*t-n-p),
        'color': 'steelblue',
        'label': None,
    }], xmin=0, xmax=xmax, ymin=0, ymax=ymax, xlabel='Time (s)', ylabel='Height (ft)', title='')
    save_graph(fig, filename)
    plt.close(fig)

# Height-context figures for Target 10.
_u6_save_height_graph('u6_sum_t10_height_v1.png', 4, -0.5, 4.0, 5, 40)
_u6_save_height_graph('u6_sum_t10_height_v2.png', 5, -0.25, 3.5, 4.5, 35)
_u6_save_height_graph('u6_sum_t10_height_v3.png', 3, -0.4, 5.0, 6, 50)
_u6_save_height_graph('u6_sum_t10_height_v4.png', 4, -0.75, 4.5, 5.5, 50)
_u6_save_height_graph('u6_sum_t10_height_v5.png', 6, -0.3, 3.8, 4.8, 45)
_u6_save_height_graph('u6_sum_t10_height_v6.png', 3, -0.6, 5.2, 6.2, 55)
_u6_save_height_graph('u6_sum_t10_height_v7.png', 5, -0.2, 3.4, 4.4, 35)
_u6_save_height_graph('u6_sum_t10_height_v8.png', 4, -0.5, 4.8, 5.8, 50)
