...
# Unit 7 summative version-specific figure blocks appended below the final marker.

def _u7_save_exp_graph(filename, a, b, k=0):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    make_standard_graph(ax, [{
        'expr': lambda x, a=a, b=b, k=k: a*(b**x) + k,
        'deriv': lambda x, a=a, b=b: a*np.log(b)*(b**x),
        'color': 'steelblue',
        'label': None,
    }], title='')
    save_graph(fig, filename)
...
# Target 6: graphing and analyzing exponential functions.
_u7_save_exp_graph('u7_sum_t6_exp_v1.png', 3, 2, 0)
_u7_save_exp_graph('u7_sum_t6_exp_v2.png', 5, 0.5, 0)
_u7_save_exp_graph('u7_sum_t6_exp_v3.png', 4, 1.5, 1)
_u7_save_exp_graph('u7_sum_t6_exp_v4.png', 6, 0.75, 2)
_u7_save_exp_graph('u7_sum_t6_exp_v5.png', 2, 3, 0)
_u7_save_exp_graph('u7_sum_t6_exp_v6.png', 8, 0.6, 1)
_u7_save_exp_graph('u7_sum_t6_exp_v7.png', 5, 1.4, -1)
_u7_save_exp_graph('u7_sum_t6_exp_v8.png', 7, 0.8, 2)


def _u7_save_compare_graph(filename, lin_b, lin_m, exp_a, exp_b, xmax, ymax):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    make_context_graph(ax, [
        {'expr': lambda x, b0=lin_b, m=lin_m: b0 + m*x,
         'deriv': lambda x, m=lin_m: 0*x + m,
         'color': 'steelblue', 'label': 'A'},
        {'expr': lambda x, a=exp_a, b=exp_b: a*(b**x),
         'deriv': lambda x, a=exp_a, b=exp_b: a*np.log(b)*(b**x),
         'color': 'firebrick', 'label': 'B'},
    ], xmin=0, xmax=xmax, ymin=0, ymax=ymax, xlabel='Input', ylabel='Output', title='')
    save_graph(fig, filename)
    plt.close(fig)

# Target 7: comparing linear and exponential models.
_u7_save_compare_graph('u7_sum_t7_compare_v1.png', 20, 8, 20, 1.3, 6, 100)
_u7_save_compare_graph('u7_sum_t7_compare_v2.png', 30, 6, 12, 1.5, 7, 120)
_u7_save_compare_graph('u7_sum_t7_compare_v3.png', 10, 12, 10, 1.4, 7, 140)
_u7_save_compare_graph('u7_sum_t7_compare_v4.png', 15, 9, 8, 1.6, 6, 100)
_u7_save_compare_graph('u7_sum_t7_compare_v5.png', 40, 5, 14, 1.45, 7, 150)
_u7_save_compare_graph('u7_sum_t7_compare_v6.png', 18, 10, 18, 1.25, 8, 120)
_u7_save_compare_graph('u7_sum_t7_compare_v7.png', 24, 7, 9, 1.7, 6, 120)
_u7_save_compare_graph('u7_sum_t7_compare_v8.png', 12, 11, 6, 1.8, 6, 120)


def _u7_save_scatter(filename, xs, ys, xmax, ymax):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    make_scatter_plot(ax, xs, ys, xmin=0, xmax=xmax, ymin=0, ymax=ymax, xlabel='Time', ylabel='Amount', title='')
    save_graph(fig, filename)
    plt.close(fig)

# Target 10: exponential modeling with data.
_u7_save_scatter('u7_sum_t10_scatter_v1.png', [0,1,2,3,4,5], [120,180,272,405,615,920], 5, 1000)
_u7_save_scatter('u7_sum_t10_scatter_v2.png', [0,1,2,3,4,5], [500,400,318,255,202,164], 5, 550)
_u7_save_scatter('u7_sum_t10_scatter_v3.png', [0,1,2,3,4,5], [60,90,138,207,310,468], 5, 520)
_u7_save_scatter('u7_sum_t10_scatter_v4.png', [0,1,2,3,4,5], [960,720,545,410,308,230], 5, 1000)
_u7_save_scatter('u7_sum_t10_scatter_v5.png', [0,1,2,3,4,5], [80,112,156,220,305,430], 5, 470)
_u7_save_scatter('u7_sum_t10_scatter_v6.png', [0,1,2,3,4,5], [700,560,450,360,285,228], 5, 760)
_u7_save_scatter('u7_sum_t10_scatter_v7.png', [0,1,2,3,4,5], [35,70,142,280,565,1120], 5, 1200)
_u7_save_scatter('u7_sum_t10_scatter_v8.png', [0,1,2,3,4,5], [640,320,165,82,43,21], 5, 700)
