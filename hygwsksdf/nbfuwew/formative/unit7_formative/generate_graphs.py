...
# Unit 7 formative graph generation blocks
# Appended below the final marker; graph_tool source above is unchanged.

_save_standard('u7_f_blank_coordinate_sq_v1.png', [], title='')

_save_standard('u7_f_dok1_3_growth_v5_sq_v1.png', [_std_exp(2, 1.6, color='steelblue')], title='')
_save_standard('u7_f_dok1_3_decay_v6_sq_v1.png', [_std_exp(8, 0.55, color='steelblue')], title='')

_save_standard('u7_f_dok2_3_shifted_decay_v5_sq_v1.png', [_std_exp(6, 0.5, d=2, color='steelblue')], title='')
_save_standard('u7_f_dok2_3_shifted_growth_v6_sq_v1.png', [_std_exp(1.5, 1.7, d=-2, color='steelblue')], title='')
_save_standard('u7_f_dok2_3_compare_v7_sq_v1.png', [
    _std_exp(2, 2, color='steelblue', label=r'$f$'),
    _std_exp(5, 2, color='firebrick', label=r'$g$')], title='')
_save_standard('u7_f_dok2_3_compare_v8_sq_v1.png', [
    _std_exp(1, 1.6, color='steelblue', label=r'$f$'),
    _std_exp(4, 1.6, color='firebrick', label=r'$g$')], title='')

_save_standard('u7_f_dok2_4_compare_v5_sq_v1.png', [
    _std_line(1.2, 2, color='firebrick', label=r'$L$'),
    _std_exp(1.5, 1.45, color='steelblue', label=r'$E$')], title='')
_save_standard('u7_f_dok2_4_compare_v6_sq_v1.png', [
    _std_line(0.9, 1, color='firebrick', label=r'$L$'),
    _std_exp(1.2, 1.55, color='steelblue', label=r'$E$')], title='')
_save_scatter('u7_f_dok2_4_scatter_growth_v7_sq_v1.png', [0,1,2,3,4,5,6], [80,118,176,268,405,610,925], 0, 6, 0, 1000, xlabel='Day', ylabel='Views', title='')
_save_scatter('u7_f_dok2_4_scatter_decay_v8_sq_v1.png', [0,1,2,3,4,5,6], [600,420,300,205,150,103,75], 0, 6, 0, 650, xlabel='Time', ylabel='Amount', title='')

_save_standard('u7_f_dok3_2_decay_v1_sq_v1.png', [_std_exp(4, 0.5, color='steelblue')], title='')
_save_standard('u7_f_dok3_2_growth_v2_sq_v1.png', [_std_exp(3, 2, color='steelblue')], title='')
_save_standard('u7_f_dok3_2_decay_v3_sq_v1.png', [_std_exp(8, 0.5, color='steelblue')], title='')
_save_standard('u7_f_dok3_2_growth_v4_sq_v1.png', [_std_exp(2, 3, color='steelblue')], title='')

_save_scatter('u7_f_dok3_4_scatter_growth_v5_sq_v1.png', [0,1,2,3,4,5], [80,118,176,268,405,610], 0, 5, 0, 650, xlabel='Time', ylabel='Amount', title='')
_save_scatter('u7_f_dok3_4_scatter_decay_v6_sq_v1.png', [0,1,2,3,4,5], [600,420,300,205,150,103], 0, 5, 0, 650, xlabel='Time', ylabel='Amount', title='')

_save_standard('u7_f_dok4_4_shifted_growth_v7_sq_v1.png', [_std_exp(1.5, 1.6, d=2, color='steelblue')], title='')
_save_standard('u7_f_dok4_4_shifted_decay_v8_sq_v1.png', [_std_exp(7, 0.6, d=1, color='steelblue')], title='')
