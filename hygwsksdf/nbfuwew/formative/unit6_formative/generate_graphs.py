...
# ─────────────────────────────────────────────────────────────────────────────
# UNIT 6 FORMATIVE FIGURE GENERATION BLOCKS
# ─────────────────────────────────────────────────────────────────────────────

# u6_f_dok2_1_v7_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-2)*(x-7), 'deriv':lambda x: 2*x-9, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok2_1_v7_graph.png')
plt.close(fig)


# u6_f_dok2_1_v8_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x+3)*(x-5), 'deriv':lambda x: 2*x-2, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok2_1_v8_graph.png')
plt.close(fig)


# u6_f_dok2_2_v7_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-3)**2-4, 'deriv':lambda x: 2*(x-3), 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok2_2_v7_graph.png')
plt.close(fig)


# u6_f_dok2_2_v8_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: -(x+2)**2+9, 'deriv':lambda x: -2*(x+2), 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok2_2_v8_graph.png')
plt.close(fig)


# u6_f_dok2_3_v7_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: x**2-2*x-2, 'deriv':lambda x: 2*x-2, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok2_3_v7_graph.png')
plt.close(fig)


# u6_f_dok2_3_v8_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: 2*x**2+3*x-5, 'deriv':lambda x: 4*x+3, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok2_3_v8_graph.png')
plt.close(fig)


# u6_f_dok2_4_v7_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -5*(x-3)**2+45, 'deriv':lambda x: -10*(x-3), 'color':'steelblue'}], 0, 8, 0, 70, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok2_4_v7_context.png')
plt.close(fig)


# u6_f_dok2_4_v8_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -4*(x-4)**2+64, 'deriv':lambda x: -8*(x-4), 'color':'steelblue'}], 0, 8, 0, 70, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok2_4_v8_context.png')
plt.close(fig)


# u6_f_dok3_1_v5_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-1)*(x-6), 'deriv':lambda x: 2*x-7, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_1_v5_graph.png')
plt.close(fig)


# u6_f_dok3_1_v6_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x+2)*(x-5), 'deriv':lambda x: 2*x-3, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_1_v6_graph.png')
plt.close(fig)


# u6_f_dok3_1_v7_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-2)*(x-7), 'deriv':lambda x: 2*x-9, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_1_v7_graph.png')
plt.close(fig)


# u6_f_dok3_1_v8_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x+4)*(x-1), 'deriv':lambda x: 2*x+3, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_1_v8_graph.png')
plt.close(fig)


# u6_f_dok3_2_v5_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: x**2-6*x+5, 'deriv':lambda x: 2*x-6, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_2_v5_graph.png')
plt.close(fig)


# u6_f_dok3_2_v6_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: x**2+4*x-1, 'deriv':lambda x: 2*x+4, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_2_v6_graph.png')
plt.close(fig)


# u6_f_dok3_2_v7_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: 2*x**2+9*x-5, 'deriv':lambda x: 4*x+9, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_2_v7_graph.png')
plt.close(fig)


# u6_f_dok3_2_v8_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: x**2-10*x+18, 'deriv':lambda x: 2*x-10, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_2_v8_graph.png')
plt.close(fig)


# u6_f_dok3_3_v7_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: x**2-9*x+17, 'deriv':lambda x: 2*x-9, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_3_v7_graph.png')
plt.close(fig)


# u6_f_dok3_3_v8_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: 2*x**2+9*x-5, 'deriv':lambda x: 4*x+9, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_3_v8_graph.png')
plt.close(fig)


# u6_f_dok3_4_v5_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-4)*(x-6), 'deriv':lambda x: 2*x-10, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_4_v5_graph.png')
plt.close(fig)


# u6_f_dok3_4_v6_graph.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr':lambda x: (x-1)*(x-7), 'deriv':lambda x: 2*x-8, 'color':'steelblue'}], title='')
save_graph(fig, 'u6_f_dok3_4_v6_graph.png')
plt.close(fig)


# u6_f_dok3_4_v7_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -4*(x-5)**2+60, 'deriv':lambda x: -8*(x-5), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok3_4_v7_context.png')
plt.close(fig)


# u6_f_dok3_4_v8_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -5*(x-4)**2+80, 'deriv':lambda x: -10*(x-4), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok3_4_v8_context.png')
plt.close(fig)


# u6_f_dok4_1_v1_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -4*(x-5)**2+60, 'deriv':lambda x: -8*(x-5), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok4_1_v1_context.png')
plt.close(fig)


# u6_f_dok4_1_v2_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -5*(x-4)**2+80, 'deriv':lambda x: -10*(x-4), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok4_1_v2_context.png')
plt.close(fig)


# u6_f_dok4_1_v3_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -3*(x-6)**2+75, 'deriv':lambda x: -6*(x-6), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok4_1_v3_context.png')
plt.close(fig)


# u6_f_dok4_1_v4_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -4*(x-3)**2+50, 'deriv':lambda x: -8*(x-3), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok4_1_v4_context.png')
plt.close(fig)


# u6_f_dok4_1_v5_area.png
make_rectangle_model([r'$x$', r'$6$'], [r'$x$', r'$4$'], [[r'$x^2$', ''], ['', r'$24$']], 'u6_f_dok4_1_v5_area.png')
plt.close('all')


# u6_f_dok4_1_v6_area.png
make_rectangle_model([r'$x$', r'$5$'], [r'$x$', r'$3$'], [[r'$x^2$', ''], ['', r'$15$']], 'u6_f_dok4_1_v6_area.png')
plt.close('all')


# u6_f_dok4_3_v1_area.png
make_rectangle_model([r'$x$', r'$6$'], [r'$x$', r'$4$'], [[r'$x^2$', ''], ['', r'$24$']], 'u6_f_dok4_3_v1_area.png')
plt.close('all')


# u6_f_dok4_3_v2_area.png
make_rectangle_model([r'$x$', r'$7$'], [r'$x$', r'$3$'], [[r'$x^2$', ''], ['', r'$21$']], 'u6_f_dok4_3_v2_area.png')
plt.close('all')


# u6_f_dok4_3_v3_area.png
make_rectangle_model([r'$x$', r'$5$'], [r'$x$', r'$8$'], [[r'$x^2$', ''], ['', r'$40$']], 'u6_f_dok4_3_v3_area.png')
plt.close('all')


# u6_f_dok4_3_v4_area.png
make_rectangle_model([r'$x$', r'$2$'], [r'$x$', r'$9$'], [[r'$x^2$', ''], ['', r'$18$']], 'u6_f_dok4_3_v4_area.png')
plt.close('all')


# u6_f_dok4_3_v5_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -4*(x-5)**2+60, 'deriv':lambda x: -8*(x-5), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok4_3_v5_context.png')
plt.close(fig)


# u6_f_dok4_3_v6_context.png
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr':lambda x: -5*(x-4)**2+80, 'deriv':lambda x: -10*(x-4), 'color':'steelblue'}], 0, 10, 0, 90, xlabel='Time', ylabel='Height', title='')
save_graph(fig, 'u6_f_dok4_3_v6_context.png')
plt.close(fig)


# =============================================================================
# Unit 6 Formative — graph-generation blocks appended 2026-06-13
# =============================================================================

# --- DOK 2.1 V7: quadratic y = x²-x-6, zeros at -2 and 3 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - x - 6,
                           'deriv': lambda x: 2*x - 1,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok2_1_v7_graph.png')
plt.close(fig)

# --- DOK 2.1 V8: quadratic y = x²-4x-5, zeros at -1 and 5 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 4*x - 5,
                           'deriv': lambda x: 2*x - 4,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok2_1_v8_graph.png')
plt.close(fig)

# --- DOK 2.2 V7: y=(x-3)²-4, zeros 1 and 5, vertex (3,-4) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: (x - 3)**2 - 4,
                           'deriv': lambda x: 2*(x - 3),
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok2_2_v7_graph.png')
plt.close(fig)

# --- DOK 2.2 V8: y=-(x+2)²+9, zeros -5 and 1, vertex (-2,9) opens down ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: -(x + 2)**2 + 9,
                           'deriv': lambda x: -2*(x + 2),
                           'color': 'firebrick', 'label': None}], title='')
save_graph(fig, 'u6_f_dok2_2_v8_graph.png')
plt.close(fig)

# --- DOK 2.3 V7: y=x²-2x-2, zeros 1±√3, vertex (1,-3) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 2*x - 2,
                           'deriv': lambda x: 2*x - 2,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok2_3_v7_graph.png')
plt.close(fig)

# --- DOK 2.3 V8: y=2x²+3x-5, zeros -2.5 and 1, vertex (-0.75,-6.125) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: 2*x**2 + 3*x - 5,
                           'deriv': lambda x: 4*x + 3,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok2_3_v8_graph.png')
plt.close(fig)

# --- DOK 2.4 V7: h(t)=-t²+6t, max (3,9), lands at t=6 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -t**2 + 6*t,
                          'deriv': lambda t: -2*t + 6,
                          'color': 'steelblue', 'label': None}],
                   0, 7, 0, 10, xlabel='Time (s)', ylabel='Height (m)', title='')
save_graph(fig, 'u6_f_dok2_4_v7_context.png')
plt.close(fig)

# --- DOK 2.4 V8: h(t)=-t²+8t, max (4,16), lands at t=8 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -t**2 + 8*t,
                          'deriv': lambda t: -2*t + 8,
                          'color': 'steelblue', 'label': None}],
                   0, 9, 0, 18, xlabel='Time (s)', ylabel='Height (m)', title='')
save_graph(fig, 'u6_f_dok2_4_v8_context.png')
plt.close(fig)

# --- DOK 3.1 V5: y=x²-7x+6, zeros 1 and 6, vertex (3.5,-6.25) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 7*x + 6,
                           'deriv': lambda x: 2*x - 7,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_1_v5_graph.png')
plt.close(fig)

# --- DOK 3.1 V6: y=x²-3x-10, zeros -2 and 5, vertex (1.5,-12.25) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 3*x - 10,
                           'deriv': lambda x: 2*x - 3,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_1_v6_graph.png')
plt.close(fig)

# --- DOK 3.1 V7: y=x²-9x+14, zeros 2 and 7, vertex (4.5,-6.25) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 9*x + 14,
                           'deriv': lambda x: 2*x - 9,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_1_v7_graph.png')
plt.close(fig)

# --- DOK 3.1 V8: y=x²+3x-4, zeros -4 and 1, vertex (-1.5,-6.25) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 + 3*x - 4,
                           'deriv': lambda x: 2*x + 3,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_1_v8_graph.png')
plt.close(fig)

# --- DOK 3.2 V5: y=x²-6x+5, zeros 1 and 5, vertex (3,-4) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 6*x + 5,
                           'deriv': lambda x: 2*x - 6,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_2_v5_graph.png')
plt.close(fig)

# --- DOK 3.2 V6: y=x²+4x-1, zeros -2±√5, vertex (-2,-5) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 + 4*x - 1,
                           'deriv': lambda x: 2*x + 4,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_2_v6_graph.png')
plt.close(fig)

# --- DOK 3.2 V7: y=x²-4x+3, zeros 1 and 3, correct vertex (2,-1) ---
# Student wrongly claimed vertex (2,-5); equation now shown in V7 task
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 4*x + 3,
                           'deriv': lambda x: 2*x - 4,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_2_v7_graph.png')
plt.close(fig)

# --- DOK 3.2 V8: y=x²-10x+18, zeros 5±√7, vertex (5,-7) ---
# Student wrongly wrote y=(x-5)²+7; correct is y=(x-5)²-7
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 10*x + 18,
                           'deriv': lambda x: 2*x - 10,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_2_v8_graph.png')
plt.close(fig)

# --- DOK 3.3 V7: y=x²-9x+17, zeros ≈2.70 and 6.30, vertex (4.5,-3.25) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: x**2 - 9*x + 17,
                          'deriv': lambda x: 2*x - 9,
                          'color': 'steelblue', 'label': None}],
                   0, 9, -5, 5, xlabel='x', ylabel='y', title='')
save_graph(fig, 'u6_f_dok3_3_v7_graph.png')
plt.close(fig)

# --- DOK 3.3 V8: y=2x²+9x-5, zeros -5 and 0.5, vertex (-2.25,-6.125) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: 2*x**2 + 9*x - 5,
                           'deriv': lambda x: 4*x + 9,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_3_v8_graph.png')
plt.close(fig)

# --- DOK 3.4 V5: y=x²-10x+24, zeros 4 and 6, vertex (5,-1) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: x**2 - 10*x + 24,
                          'deriv': lambda x: 2*x - 10,
                          'color': 'steelblue', 'label': None}],
                   0, 10, -3, 6, xlabel='x', ylabel='y', title='')
save_graph(fig, 'u6_f_dok3_4_v5_graph.png')
plt.close(fig)

# --- DOK 3.4 V6: y=x²-8x+7, zeros 1 and 7, vertex (4,-9) ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: x**2 - 8*x + 7,
                           'deriv': lambda x: 2*x - 8,
                           'color': 'steelblue', 'label': None}], title='')
save_graph(fig, 'u6_f_dok3_4_v6_graph.png')
plt.close(fig)

# --- DOK 3.4 V7: h(t)=-t²+6t, max (3,9), context height model ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -t**2 + 6*t,
                          'deriv': lambda t: -2*t + 6,
...
# --- DOK 3.4 V8: h(t)=-2t²+10t, max (2.5,12.5), lands at t=5 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -2*t**2 + 10*t,
                          'deriv': lambda t: -4*t + 10,
                          'color': 'steelblue', 'label': None}],
                   0, 6, 0, 14, xlabel='Time (s)', ylabel='Height (m)', title='')
save_graph(fig, 'u6_f_dok3_4_v8_context.png')
plt.close(fig)

# --- DOK 4.1 V1: h=-t²+4t, max (2,4), lands at t=4 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -t**2 + 4*t,
                          'deriv': lambda t: -2*t + 4,
                          'color': 'steelblue', 'label': None}],
                   0, 5, 0, 5, xlabel='Time (s)', ylabel='Height (m)', title='')
save_graph(fig, 'u6_f_dok4_1_v1_context.png')
plt.close(fig)

# --- DOK 4.1 V2: h=-t²+6t, max (3,9), lands at t=6 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -t**2 + 6*t,
                          'deriv': lambda t: -2*t + 6,
...
# --- DOK 4.1 V3: h=-t²+5t, max (2.5,6.25), lands at t=5 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -t**2 + 5*t,
                          'deriv': lambda t: -2*t + 5,
                          'color': 'steelblue', 'label': None}],
                   0, 6, 0, 8, xlabel='Time (s)', ylabel='Height (m)', title='')
save_graph(fig, 'u6_f_dok4_1_v3_context.png')
plt.close(fig)

# --- DOK 4.1 V4: h=-t²+7t, max (3.5,12.25), lands at t=7 ---
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda t: -t**2 + 7*t,
                          'deriv': lambda t: -2*t + 7,
                          'color': 'steelblue', 'label': None}],
                   0, 8, 0, 14, xlabel='Time (s)', ylabel='Height (m)', title='')
save_graph(fig, 'u6_f_dok4_1_v4_context.png')
plt.close(fig)

# --- DOK 4.1 V5: Area model, (x)(x+2)=80, partially blank interior ---
make_rectangle_model(
    row_labels=[r'$x$'],
    col_labels=[r'$x$', r'$2$'],
    cell_values=[[r'', r'']],
    filename='u6_f_dok4_1_v5_area.png'
)
plt.close('all')

# --- DOK 4.1 V6: Area model, (x+3)(x+5)=63, diagonal cells shown ---
make_rectangle_model(
    row_labels=[r'$x$', r'$3$'],
    col_labels=[r'$x$', r'$5$'],
    cell_values=[[r'$x^2$', r''], [r'', r'$15$']],
    filename='u6_f_dok4_1_v6_area.png'
)
plt.close('all')

# --- DOK 4.3 V1: Area model (x+4)(x+6)=80, all cells filled ---
make_rectangle_model(
    row_labels=[r'$x$', r'$4$'],
    col_labels=[r'$x$', r'$6$'],
    cell_values=[[r'$x^2$', r'$6x$'], [r'$4x$', r'$24$']],
    filename='u6_f_dok4_3_v1_area.png'
)
plt.close('all')

# --- DOK 4.3 V2: Area model (x+2)(x+8)=91, all cells filled ---
make_rectangle_model(
    row_labels=[r'$x$', r'$2$'],
    col_labels=[r'$x$', r'$8$'],
    cell_values=[[r'$x^2$', r'$8x$'], [r'$2x$', r'$16$']],
    filename='u6_f_dok4_3_v2_area.png'
)
plt.close('all')

# --- DOK 4.3 V3: Area model (x+3)(x+8)=104, all cells filled ---
make_rectangle_model(
    row_labels=[r'$x$', r'$3$'],
    col_labels=[r'$x$', r'$8$'],
    cell_values=[[r'$x^2$', r'$8x$'], [r'$3x$', r'$24$']],
    filename='u6_f_dok4_3_v3_area.png'
)
plt.close('all')

# --- DOK 4.3 V4: Area model (x+3)(x+9)=72, all cells filled ---
make_rectangle_model(
    row_labels=[r'$x$', r'$3$'],
    col_labels=[r'$x$', r'$9$'],
    cell_values=[[r'$x^2$', r'$9x$'], [r'$3x$', r'$27$']],
    filename='u6_f_dok4_3_v4_area.png'
)
plt.close('all')

# --- DOK 4.3 V5: y=-(x-5)²+4, zeros 3 and 7, vertex (5,4), opens down ---
# Student claimed y=4(x-5)²+60 (wrong sign, wrong value)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x: -(x - 5)**2 + 4,
                           'deriv': lambda x: -2*(x - 5),
                           'color': 'firebrick', 'label': None}], title='')
save_graph(fig, 'u6_f_dok4_3_v5_context.png')
plt.close(fig)

# --- DOK 4.3 V6: y=-(x-4)²+25, zeros -1 and 9, vertex (4,25), opens down ---
# Student claimed y=5(x-4)²+80 (wrong sign, wrong value)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x: -(x - 4)**2 + 25,
                          'deriv': lambda x: -2*(x - 4),
                          'color': 'firebrick', 'label': None}],
                   -2, 10, -5, 28, xlabel='x', ylabel='y', title='')
save_graph(fig, 'u6_f_dok4_3_v6_context.png')
plt.close(fig)
