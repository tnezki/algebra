...
if __name__ == '__main__':
    ...
    make_algebra_tiles({'x2':1,'x':3,'one':3}, filename='u5_s1_wtc.png')
    make_diamond(20,4,5,9,filename='u5_s2_wtc.png')
    make_diamond(15,5,3,8,filename='u5_s3_wtc.png')
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(0.25,-2,2)],''); save_graph(fig0,'u5_s4_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(-0.25,-1,-2)],''); save_graph(fig0,'u5_s5_wtc.png'); plt.close(fig0)
