...
# Unit 5 canonical figure calls (appended; framework tool above is unchanged).
make_rectangle_model(['x', '3'], ['x', '4'], [['x^2', '4x'], ['3x', '12']], filename='u5_5_2_wtc_rectangle.png')
make_rectangle_model(['x', '5'], ['x', '5'], [['x^2', '5x'], ['5x', '25']], filename='u5_5_3_wtc_square.png')
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-2))*(x-(3)), 'deriv': lambda x: 1*(2*x-(1)), 'color': 'steelblue'}], title='')
ax.set_xlim(-6, 6); ax.set_ylim(-8, 12)
save_graph(fig, 'u5_5_4_wtc_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-1))*(x-(3)), 'deriv': lambda x: 1*(2*x-(2)), 'color': 'steelblue'}], title='')
ax.set_xlim(-5, 5); ax.set_ylim(-6, 10)
save_graph(fig, 'u5_5_5_wtc_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [], title='')
ax.set_xlim(-8, 8); ax.set_ylim(-8, 8)
save_graph(fig, 'u5_5_5_blank_plane.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-4))*(x-(2)), 'deriv': lambda x: 1*(2*x-(-2)), 'color': 'steelblue'}], title='')
ax.set_xlim(-7, 6); ax.set_ylim(-10, 12)
save_graph(fig, 'u5_5_4_notes_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-3))*(x-(1)), 'deriv': lambda x: 1*(2*x-(-2)), 'color': 'steelblue'}], title='')
ax.set_xlim(-6, 5); ax.set_ylim(-8, 10)
save_graph(fig, 'u5_5_5_notes_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-4))*(x-(1)), 'deriv': lambda x: 1*(2*x-(-3)), 'color': 'steelblue'}], title='')
ax.set_xlim(-7, 4); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_4_practice_form1_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-1))*(x-(4)), 'deriv': lambda x: 1*(2*x-(3)), 'color': 'steelblue'}], title='')
ax.set_xlim(-4, 7); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_4_practice_form2_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-2))*(x-(2)), 'deriv': lambda x: 1*(2*x-(0)), 'color': 'steelblue'}], title='')
ax.set_xlim(-5, 5); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_4_practice_form3_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-2))*(x-(5)), 'deriv': lambda x: 1*(2*x-(3)), 'color': 'steelblue'}], title='')
ax.set_xlim(-5, 8); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_4_practice_form4_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-2))*(x-(4)), 'deriv': lambda x: 1*(2*x-(2)), 'color': 'steelblue'}], title='')
ax.set_xlim(-5, 7); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_5_practice_form1_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-5))*(x-(1)), 'deriv': lambda x: 1*(2*x-(-4)), 'color': 'steelblue'}], title='')
ax.set_xlim(-8, 4); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_5_practice_form2_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(1))*(x-(5)), 'deriv': lambda x: 1*(2*x-(6)), 'color': 'steelblue'}], title='')
ax.set_xlim(-2, 8); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_5_practice_form3_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-3))*(x-(2)), 'deriv': lambda x: 1*(2*x-(-1)), 'color': 'steelblue'}], title='')
ax.set_xlim(-6, 5); ax.set_ylim(-10, 14)
save_graph(fig, 'u5_5_5_practice_form4_graph.png')
plt.close(fig)
make_diamond('', '2x', '3', '', filename='u5_5_1_diamond.png')
make_diamond('', '3', '4', '', filename='u5_5_2_diamond.png')
make_diamond('', '$x+4$', '$x-4$', '', filename='u5_5_3_diamond.png')
make_diamond('', '-3', '2', '', filename='u5_5_4_diamond.png')
make_diamond('', '$x+1$', '$x-3$', '', filename='u5_5_5_diamond.png')

# Representation-pass secure alternate graph-error stimulus.
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_inequality_graph(ax, [{'expr': lambda x: -3*x+2, 'deriv': lambda x: -3+0*x, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}], title='')
save_graph(fig, 'u5_sum_v5_04_incorrect_ineq.png')
plt.close(fig)


# 3f Evidence/Assessment Upgrade figures.
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: 1*(x-(-2))*(x-(4)), 'deriv': lambda x: 1*(2*x-(2)), 'color': 'steelblue'}], title='')
save_graph(fig, 'u5_5_2_exit_review_graph.png')
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [{'expr': lambda x: np.power(2.0, x)-1, 'deriv': lambda x: np.log(2.0)*np.power(2.0, x), 'color': 'steelblue'}], title='')
save_graph(fig, 'u5_5_3_exit_review_graph.png')
plt.close(fig)
