...
if __name__ == '__main__':
    ...
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[expo(1,1.4000000000000001,0)],''); save_graph(fig0,'u7_s1_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[expo(1,1.4500000000000002,0)],''); save_graph(fig0,'u7_s2_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[expo(1,1.35,0)],''); save_graph(fig0,'u7_s3_wtc.png'); plt.close(fig0)
    fig0=make_2x2_grid([[linear(1,0)],[quad(0.2,0,0)],[expo(1,1.45,0)],[absv(1,0,0)]],titles=['Linear','Quadratic','Exponential','Absolute value']); save_graph(fig0,'u7_s4_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[expo(1,1.4500000000000002,0)],''); save_graph(fig0,'u7_s5_wtc.png'); plt.close(fig0)
