...
# STEP3B GENERATED REPRESENTATION BLOCK — appended below registered tool marker only
# EXIT-1.1-Q1-NEW -> exit-1_1-q1-new_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'exit-1_1-q1-new_blank.png')
plt.close(fig)
# EXIT-1.1-Q2-NEW -> exit-1_1-q2-new_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=1, b=2: m*x+b, 'deriv': lambda x, m=1: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'exit-1_1-q2-new_graph.png')
plt.close(fig)
# EXIT-1.1-Q3-NEW -> exit-1_1-q3-new_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'exit-1_1-q3-new_blank.png')
plt.close(fig)
# EXIT-1.1-Q4-NEW -> exit-1_1-q4-new_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=3, b=8: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}], 0, 10, 0, 35, xlabel='Time (min)', ylabel='Amount')
save_graph(fig, 'exit-1_1-q4-new_context.png')
plt.close(fig)
# EXIT-1.2-Q3-REASSESS -> exit-1_2-q3-reassess_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'exit-1_2-q3-reassess_blank.png')
plt.close(fig)
# EXIT-1.2-Q4-REASSESS -> exit-1_2-q4-reassess_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=4: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'exit-1_2-q4-reassess_graph.png')
plt.close(fig)
# EXIT-1.3-Q1-NEW -> exit-1_3-q1-new_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'exit-1_3-q1-new_graph.png')
plt.close(fig)
# EXIT-1.4-Q1-NEW -> exit-1_4-q1-new_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-1, b=-3: m*x+b, 'deriv': lambda x, m=-1: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'exit-1_4-q1-new_graph.png')
plt.close(fig)
# EXIT-1.4-Q2-NEW -> exit-1_4-q2-new_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=2, b=6: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}], 0, 10, 0, 35, xlabel='Time (min)', ylabel='Amount')
save_graph(fig, 'exit-1_4-q2-new_context.png')
plt.close(fig)
# EXIT-1.4-Q3-REASSESS -> exit-1_4-q3-reassess_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=5: m*x+b, 'deriv': lambda x, m=-2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'exit-1_4-q3-reassess_graph.png')
plt.close(fig)
# EXIT-1.5-Q3-REASSESS -> exit-1_5-q3-reassess_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=1, b=2: m*x+b, 'deriv': lambda x, m=1: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'exit-1_5-q3-reassess_graph.png')
plt.close(fig)
# EXIT-1.5-Q4-REASSESS -> exit-1_5-q4-reassess_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=2, b=10: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}], 0, 10, 0, 35, xlabel='Time (min)', ylabel='Amount')
save_graph(fig, 'exit-1_5-q4-reassess_context.png')
plt.close(fig)
# SUM-V1-S1 -> sum-v1-s1_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'sum-v1-s1_blank.png')
plt.close(fig)
# SUM-V1-S2 -> sum-v1-s2_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=2, b=6: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}], 0, 10, 0, 30, xlabel='Minutes', ylabel='Water (L)')
save_graph(fig, 'sum-v1-s2_context.png')
plt.close(fig)
# SUM-V1-S3 -> sum-v1-s3_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'sum-v1-s3_graph.png')
plt.close(fig)
# SUM-V2-S1 -> sum-v2-s1_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'sum-v2-s1_blank.png')
plt.close(fig)
# SUM-V2-S2 -> sum-v2-s2_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=3, b=9: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}], 0, 8, 0, 40, xlabel='Days', ylabel='Balance ($)')
save_graph(fig, 'sum-v2-s2_context.png')
plt.close(fig)
# SUM-V2-S3 -> sum-v2-s3_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=4: m*x+b, 'deriv': lambda x, m=-2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'sum-v2-s3_graph.png')
plt.close(fig)
# SUM-V3-S1 -> sum-v3-s1_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'sum-v3-s1_blank.png')
plt.close(fig)
# SUM-V3-S2 -> sum-v3-s2_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=4, b=4: m*x+b, 'deriv': lambda x, m=4: 0*x+m, 'color':'steelblue'}], 0, 7, 0, 35, xlabel='Hours', ylabel='Distance (mi)')
save_graph(fig, 'sum-v3-s2_context.png')
plt.close(fig)
# SUM-V3-S3 -> sum-v3-s3_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=3, b=-3: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'sum-v3-s3_graph.png')
plt.close(fig)
# SUM-V4-S1 -> sum-v4-s1_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'sum-v4-s1_blank.png')
plt.close(fig)
# SUM-V4-S2 -> sum-v4-s2_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=5, b=10: m*x+b, 'deriv': lambda x, m=5: 0*x+m, 'color':'steelblue'}], 0, 6, 0, 45, xlabel='Weeks', ylabel='Pages read')
save_graph(fig, 'sum-v4-s2_context.png')
plt.close(fig)
# SUM-V4-S3 -> sum-v4-s3_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-1, b=5: m*x+b, 'deriv': lambda x, m=-1: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'sum-v4-s3_graph.png')
plt.close(fig)
# SUM-V5-S1 -> sum-v5-s1_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'sum-v5-s1_blank.png')
plt.close(fig)
# SUM-V5-S2 -> sum-v5-s2_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=6, b=8: m*x+b, 'deriv': lambda x, m=6: 0*x+m, 'color':'steelblue'}], 0, 5, 0, 45, xlabel='Trips', ylabel='Total cost ($)')
save_graph(fig, 'sum-v5-s2_context.png')
plt.close(fig)
# SUM-V5-S3 -> sum-v5-s3_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=4, b=-2: m*x+b, 'deriv': lambda x, m=4: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'sum-v5-s3_graph.png')
plt.close(fig)
# SUM-V6-S1 -> sum-v6-s1_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'sum-v6-s1_blank.png')
plt.close(fig)
# SUM-V6-S2 -> sum-v6-s2_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=2, b=12: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}], 0, 10, 0, 40, xlabel='Practice sessions', ylabel='Points')
save_graph(fig, 'sum-v6-s2_context.png')
plt.close(fig)
# SUM-V6-S3 -> sum-v6-s3_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-3, b=2: m*x+b, 'deriv': lambda x, m=-3: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'sum-v6-s3_graph.png')
plt.close(fig)
# P1-1.1-INTRO-01 -> p1-1_1-intro-01_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_1-intro-01_graph.png')
plt.close(fig)
# P1-1.1-INTRO-03 -> p1-1_1-intro-03_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=4: m*x+b, 'deriv': lambda x, m=-2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_1-intro-03_graph.png')
plt.close(fig)
# P1-1.1-INTRO-04 -> p1-1_1-intro-04_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=4, b=0: m*x+b, 'deriv': lambda x, m=4: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_1-intro-04_graph.png')
plt.close(fig)
# P1-1.1-INTRO-06 -> p1-1_1-intro-06_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'p1-1_1-intro-06_blank.png')
plt.close(fig)
# P1-1.1-REVIEW-01 -> p1-1_1-review-01_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'p1-1_1-review-01_blank.png')
plt.close(fig)
# P1-1.1-REVIEW-04 -> p1-1_1-review-04_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=3, b=-2: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_1-review-04_graph.png')
plt.close(fig)
# P1-1.1-REVIEW-05 -> p1-1_1-review-05_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'p1-1_1-review-05_blank.png')
plt.close(fig)
# P1-1.1-MASTERY-01 -> p1-1_1-mastery-01_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'p1-1_1-mastery-01_blank.png')
plt.close(fig)
# P1-1.1-MASTERY-02 -> p1-1_1-mastery-02_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'p1-1_1-mastery-02_blank.png')
plt.close(fig)
# P1-1.1-MASTERY-03 -> p1-1_1-mastery-03_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=-2: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_1-mastery-03_graph.png')
plt.close(fig)
# P1-1.1-MASTERY-04 -> p1-1_1-mastery-04_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-1, b=-3: m*x+b, 'deriv': lambda x, m=-1: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_1-mastery-04_graph.png')
plt.close(fig)
# P1-1.1-MASTERY-05 -> p1-1_1-mastery-05_points.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
_xs=[-6, 2, 5]; _ys=[4, -5, 3]; ax.scatter(_xs,_ys,s=38,zorder=6)
ax.text(-6+0.25,4+0.25,'A',fontsize=10,fontfamily='Times New Roman')
ax.text(2+0.25,-5+0.25,'B',fontsize=10,fontfamily='Times New Roman')
ax.text(5+0.25,3+0.25,'C',fontsize=10,fontfamily='Times New Roman')
save_graph(fig, 'p1-1_1-mastery-05_points.png')
plt.close(fig)
# P1-1.1-MASTERY-06 -> p1-1_1-mastery-06_points.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
_xs=[-5, 3, 6]; _ys=[-2, 6, -4]; ax.scatter(_xs,_ys,s=38,zorder=6)
ax.text(-5+0.25,-2+0.25,'A',fontsize=10,fontfamily='Times New Roman')
ax.text(3+0.25,6+0.25,'B',fontsize=10,fontfamily='Times New Roman')
ax.text(6+0.25,-4+0.25,'C',fontsize=10,fontfamily='Times New Roman')
save_graph(fig, 'p1-1_1-mastery-06_points.png')
plt.close(fig)
# P1-1.1-MASTERY-07 -> p1-1_1-mastery-07_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=3: m*x+b, 'deriv': lambda x, m=-2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_1-mastery-07_graph.png')
plt.close(fig)
# P1-1.1-MASTERY-08 -> p1-1_1-mastery-08_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=3, b=10: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}], 0, 10, 0, 35, xlabel='Time (min)', ylabel='Amount')
save_graph(fig, 'p1-1_1-mastery-08_context.png')
plt.close(fig)
# P1-1.2-REVIEW-03 -> p1-1_2-review-03_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_2-review-03_graph.png')
plt.close(fig)
# P1-1.2-REVIEW-07 -> p1-1_2-review-07_points.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
_xs=[-3, 1, 1, 4]; _ys=[-2, 1, 5, 3]; ax.scatter(_xs,_ys,s=38,zorder=6)
save_graph(fig, 'p1-1_2-review-07_points.png')
plt.close(fig)
# P1-1.3-INTRO-02 -> p1-1_3-intro-02_family_grid.png
_fl=[[{'expr':lambda x:0.4*x*x-4,'deriv':lambda x:0.8*x,'color':'steelblue'}],[{'expr':lambda x:1.5*x-1,'deriv':lambda x:0*x+1.5,'color':'steelblue'}],[{'expr':lambda x:np.abs(x)-3,'deriv':lambda x:np.where(x<0,-1,1),'color':'steelblue'}],[{'expr':lambda x:2**(x/2)-2,'deriv':lambda x:(np.log(2)/2)*2**(x/2),'color':'steelblue'}]]
_fg=make_2x2_grid(_fl, titles=['A','B','C','D'])
save_graph(_fg, 'p1-1_3-intro-02_family_grid.png')
plt.close(_fg)
# P1-1.3-INTRO-04 -> p1-1_3-intro-04_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-intro-04_graph.png')
plt.close(fig)
# P1-1.3-INTRO-05 -> p1-1_3-intro-05_family.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=-1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-intro-05_family.png')
plt.close(fig)
# P1-1.3-INTRO-07 -> p1-1_3-intro-07_family.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x: 2**(x/2)-2, 'deriv': lambda x: (np.log(2)/2)*2**(x/2), 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-intro-07_family.png')
plt.close(fig)
# P1-1.3-REVIEW-01 -> p1-1_3-review-01_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=5: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-review-01_graph.png')
plt.close(fig)
# P1-1.3-REVIEW-03 -> p1-1_3-review-03_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=4: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-review-03_graph.png')
plt.close(fig)
# P1-1.3-REVIEW-06 -> p1-1_3-review-06_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=3, b=4: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-review-06_graph.png')
plt.close(fig)
# P1-1.3-REVIEW-08 -> p1-1_3-review-08_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=3, b=3: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-review-08_graph.png')
plt.close(fig)
# P1-1.3-MASTERY-01 -> p1-1_3-mastery-01_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-mastery-01_graph.png')
plt.close(fig)
# P1-1.3-MASTERY-05 -> p1-1_3-mastery-05_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_3-mastery-05_graph.png')
plt.close(fig)
# P1-1.4-REVIEW-03 -> p1-1_4-review-03_blank_number_line.png
fig, ax = plt.subplots(figsize=(3.5,1.25))
make_number_line_blank(ax, label='x<0', xmin=-10, xmax=10)
save_graph(fig, 'p1-1_4-review-03_blank_number_line.png')
plt.close(fig)
# P1-1.4-REVIEW-04 -> p1-1_4-review-04_blank_number_line.png
fig, ax = plt.subplots(figsize=(3.5,1.25))
make_number_line_blank(ax, label='x≥4', xmin=-10, xmax=10)
save_graph(fig, 'p1-1_4-review-04_blank_number_line.png')
plt.close(fig)
# P1-1.4-REVIEW-07 -> p1-1_4-review-07_number_line.png
fig, ax = plt.subplots(figsize=(3.5,1.25))
make_number_line(ax, [{'start': 1, 'end': 1, 'direction': 'right', 'start_open': False, 'end_open': False, 'color': 'steelblue'}], xmin=-10, xmax=10)
save_graph(fig, 'p1-1_4-review-07_number_line.png')
plt.close(fig)
# P1-1.4-REVIEW-08 -> p1-1_4-review-08_number_line.png
fig, ax = plt.subplots(figsize=(3.5,1.25))
make_number_line(ax, [{'start': 2, 'end': 2, 'direction': 'left', 'start_open': True, 'end_open': True, 'color': 'steelblue'}], xmin=-10, xmax=10)
save_graph(fig, 'p1-1_4-review-08_number_line.png')
plt.close(fig)
# P1-1.4-MASTERY-01 -> p1-1_4-mastery-01_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'p1-1_4-mastery-01_blank.png')
plt.close(fig)
# P1-1.4-MASTERY-02 -> p1-1_4-mastery-02_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'p1-1_4-mastery-02_blank.png')
plt.close(fig)
# P1-1.4-MASTERY-03 -> p1-1_4-mastery-03_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=-1: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_4-mastery-03_graph.png')
plt.close(fig)
# P1-1.4-MASTERY-04 -> p1-1_4-mastery-04_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=4: m*x+b, 'deriv': lambda x, m=-2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_4-mastery-04_graph.png')
plt.close(fig)
# P1-1.4-MASTERY-05 -> p1-1_4-mastery-05_points.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
_xs=[-4, 1, 6]; _ys=[5, -4, 2]; ax.scatter(_xs,_ys,s=38,zorder=6)
ax.text(-4+0.25,5+0.25,'A',fontsize=10,fontfamily='Times New Roman')
ax.text(1+0.25,-4+0.25,'B',fontsize=10,fontfamily='Times New Roman')
ax.text(6+0.25,2+0.25,'C',fontsize=10,fontfamily='Times New Roman')
save_graph(fig, 'p1-1_4-mastery-05_points.png')
plt.close(fig)
# P1-1.4-MASTERY-06 -> p1-1_4-mastery-06_points.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
_xs=[-6, 2, 5]; _ys=[-1, 6, -3]; ax.scatter(_xs,_ys,s=38,zorder=6)
ax.text(-6+0.25,-1+0.25,'A',fontsize=10,fontfamily='Times New Roman')
ax.text(2+0.25,6+0.25,'B',fontsize=10,fontfamily='Times New Roman')
ax.text(5+0.25,-3+0.25,'C',fontsize=10,fontfamily='Times New Roman')
save_graph(fig, 'p1-1_4-mastery-06_points.png')
plt.close(fig)
# P1-1.4-MASTERY-07 -> p1-1_4-mastery-07_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=5: m*x+b, 'deriv': lambda x, m=-2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_4-mastery-07_graph.png')
plt.close(fig)
# P1-1.4-MASTERY-08 -> p1-1_4-mastery-08_context.png
fig, ax = plt.subplots(figsize=(4.6,3.5))
make_context_graph(ax, [{'expr': lambda x, m=2, b=7: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}], 0, 10, 0, 35, xlabel='Time (min)', ylabel='Amount')
save_graph(fig, 'p1-1_4-mastery-08_context.png')
plt.close(fig)
# P1-1.5-REVIEW-01 -> p1-1_5-review-01_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=5: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_5-review-01_graph.png')
plt.close(fig)
# P1-1.5-REVIEW-03 -> p1-1_5-review-03_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=2, b=4: m*x+b, 'deriv': lambda x, m=2: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_5-review-03_graph.png')
plt.close(fig)
# P1-1.5-REVIEW-06 -> p1-1_5-review-06_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=3, b=4: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_5-review-06_graph.png')
plt.close(fig)
# P1-1.5-REVIEW-08 -> p1-1_5-review-08_graph.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [{'expr': lambda x, m=3, b=3: m*x+b, 'deriv': lambda x, m=3: 0*x+m, 'color':'steelblue'}])
save_graph(fig, 'p1-1_5-review-08_graph.png')
plt.close(fig)
# WTC-1.1 -> wtc-1_1_blank.png
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_standard_graph(ax, [])
save_graph(fig, 'wtc-1_1_blank.png')
plt.close(fig)
