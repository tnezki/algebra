...
# UNIT 2 GENERATION CALLS — appended below authoritative marker
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=3, b=1: m*x+b, 'deriv': lambda x, m=3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=6, ymin=0, ymax=22, xlabel='Time (minutes)', ylabel='Distance (blocks)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_wtc_distance.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=2, b=-3: m*x+b, 'deriv': lambda x, m=2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_graph_pos.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-0.5, b=4: m*x+b, 'deriv': lambda x, m=-0.5: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_graph_neg.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=0, b=3: m*x+b, 'deriv': lambda x, m=0: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_graph_zero.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=20, b=40: m*x+b, 'deriv': lambda x, m=20: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=220, xlabel='Weeks', ylabel='Savings (dollars)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_wtc_savings.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=4: m*x+b, 'deriv': lambda x, m=-2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_graph_a.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=0.5, b=-2: m*x+b, 'deriv': lambda x, m=0.5: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_graph_b.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=12, b=18: m*x+b, 'deriv': lambda x, m=12: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=120, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_context_trip.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=1.5, b=-3: m*x+b, 'deriv': lambda x, m=1.5: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_graph_a.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=5: m*x+b, 'deriv': lambda x, m=-2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_graph_b.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=3, b=8: m*x+b, 'deriv': lambda x, m=3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': 'Plan A'}, {'expr': lambda x, m=2, b=14: m*x+b, 'deriv': lambda x, m=2: np.full_like(x,m,dtype=float), 'color': 'firebrick', 'label': 'Plan B'}], xmin=0, xmax=8, ymin=0, ymax=40, xlabel='Hours', ylabel='Total cost (dollars)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_wtc_plans.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=1, b=2: m*x+b, 'deriv': lambda x, m=1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': 'A'}, {'expr': lambda x, m=2, b=-2: m*x+b, 'deriv': lambda x, m=2: np.full_like(x,m,dtype=float), 'color': 'firebrick', 'label': 'B'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_compare_lines.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6, 7], [4, 7, 9, 12, 14, 17, 19], xmin=0, xmax=8, ymin=0, ymax=22, line_of_best_fit=False, xlabel='Week', ylabel='Plant height (cm)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_wtc_scatter.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [5, 7, 10, 11, 14, 16], xmin=0, xmax=7, ymin=0, ymax=19, line_of_best_fit=True, xlabel='Hours studied', ylabel='Quiz score gain', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_scatter_a.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [16, 14, 13, 11, 9, 8], xmin=0, xmax=7, ymin=0, ymax=18, line_of_best_fit=True, xlabel='Age (years)', ylabel='Resale value (hundreds)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_scatter_b.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [2, 4, 8, 14, 22, 32], xmin=0, xmax=7, ymin=0, ymax=35, line_of_best_fit=False, xlabel='Time', ylabel='Measured value', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_scatter_curve.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
make_diamond('', '$2x$', '$3$', '$2x+3$', filename='u2_s21_diamond.png')
make_diamond('$-4x$', '$x$', '$-4$', '', filename='u2_s22_diamond.png')
make_diamond('$6x$', '$2x$', '$3$', '', filename='u2_s23_diamond.png')
make_diamond('', '$-2x$', '$5$', '$-2x+5$', filename='u2_s24_diamond.png')
make_diamond('$3x$', '$x$', '$3$', '', filename='u2_s25_diamond.png')
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=2, b=1: m*x+b, 'deriv': lambda x, m=2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_sum_v1_line.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-1, b=5: m*x+b, 'deriv': lambda x, m=-1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_sum_v2_line.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=0.5, b=-3: m*x+b, 'deriv': lambda x, m=0.5: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_sum_v3_line.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=3, b=0: m*x+b, 'deriv': lambda x, m=3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_sum_v4_line.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=1.5, b=-2: m*x+b, 'deriv': lambda x, m=1.5: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_sum_v6_line.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [5.9, 9.700000000000001, 12.3, 16.1, 18.7, 22.500000000000004], xmin=0, xmax=7, ymin=0, ymax=22, line_of_best_fit=False, xlabel='Input', ylabel='Observed output', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_sum_v6_scatter.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

# UNIT 2 UPGRADE v1 — additional instances only; authoritative graph-tool internals unchanged
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=1.5, b=1: m*x+b, 'deriv': lambda x, m=1.5: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_graph_c.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-0.5, b=2: m*x+b, 'deriv': lambda x, m=-0.5: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_graph_c.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

# UNIT 2 REPRESENTATION UPGRADE v1.1 — unique content-bearing instances
fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-1/2), b=-5: m*x+b, 'deriv': lambda x, m=(-1/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_notesyti_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=1, b=-5: m*x+b, 'deriv': lambda x, m=1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset1_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(1/2), b=-5: m*x+b, 'deriv': lambda x, m=(1/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset1_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=2, b=-5: m*x+b, 'deriv': lambda x, m=2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset1_06_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-1, b=-5: m*x+b, 'deriv': lambda x, m=-1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset2_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=-5: m*x+b, 'deriv': lambda x, m=-2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset2_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(3/2), b=-5: m*x+b, 'deriv': lambda x, m=(3/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset2_06_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-3/2), b=-5: m*x+b, 'deriv': lambda x, m=(-3/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset3_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(2/3), b=-5: m*x+b, 'deriv': lambda x, m=(2/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset3_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-2/3), b=-5: m*x+b, 'deriv': lambda x, m=(-2/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_practiceset3_06_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=3, b=-5: m*x+b, 'deriv': lambda x, m=3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_extrapractice_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-3, b=-5: m*x+b, 'deriv': lambda x, m=-3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_extrapractice_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(1/3), b=-5: m*x+b, 'deriv': lambda x, m=(1/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_extrapractice_06_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-1/3), b=-5: m*x+b, 'deriv': lambda x, m=(-1/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_cyu_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(3/4), b=-5: m*x+b, 'deriv': lambda x, m=(3/4): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_warmup2_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-3/4), b=-5: m*x+b, 'deriv': lambda x, m=(-3/4): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s24_exitticketa_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(4/3), b=-5: m*x+b, 'deriv': lambda x, m=(4/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset1_09_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-4/3), b=-5: m*x+b, 'deriv': lambda x, m=(-4/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset2_09_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(5/2), b=-5: m*x+b, 'deriv': lambda x, m=(5/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset3_09_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-5/2), b=-5: m*x+b, 'deriv': lambda x, m=(-5/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_extrapractice_09_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(1/2), b=-4: m*x+b, 'deriv': lambda x, m=(1/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_warmup3_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-1/2), b=-4: m*x+b, 'deriv': lambda x, m=(-1/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset1_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=1, b=-4: m*x+b, 'deriv': lambda x, m=1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset2_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-1, b=-4: m*x+b, 'deriv': lambda x, m=-1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset3_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=2, b=-4: m*x+b, 'deriv': lambda x, m=2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_extrapractice_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=-4: m*x+b, 'deriv': lambda x, m=-2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset2_07_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(3/2), b=-4: m*x+b, 'deriv': lambda x, m=(3/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_practiceset3_07_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-3/2), b=-4: m*x+b, 'deriv': lambda x, m=(-3/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_extrapractice_07_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(2/3), b=-4: m*x+b, 'deriv': lambda x, m=(2/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s21_cyu_03_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-2/3), b=-4: m*x+b, 'deriv': lambda x, m=(-2/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset1_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=3, b=-4: m*x+b, 'deriv': lambda x, m=3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset2_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-3, b=-4: m*x+b, 'deriv': lambda x, m=-3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset3_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(1/3), b=-4: m*x+b, 'deriv': lambda x, m=(1/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_extrapractice_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-1/3), b=-4: m*x+b, 'deriv': lambda x, m=(-1/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_cyu_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(3/4), b=-4: m*x+b, 'deriv': lambda x, m=(3/4): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_warmup2_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-3/4), b=-4: m*x+b, 'deriv': lambda x, m=(-3/4): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_exitticketa_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(4/3), b=-4: m*x+b, 'deriv': lambda x, m=(4/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset1_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-4/3), b=-4: m*x+b, 'deriv': lambda x, m=(-4/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset2_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(5/2), b=-4: m*x+b, 'deriv': lambda x, m=(5/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset3_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-5/2), b=-4: m*x+b, 'deriv': lambda x, m=(-5/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_extrapractice_04_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-1/2), b=-3: m*x+b, 'deriv': lambda x, m=(-1/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset2_06_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=1, b=-3: m*x+b, 'deriv': lambda x, m=1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset3_06_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-1, b=-3: m*x+b, 'deriv': lambda x, m=-1: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_extrapractice_06_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-2, b=-3: m*x+b, 'deriv': lambda x, m=-2: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset1_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-3/2), b=-3: m*x+b, 'deriv': lambda x, m=(-3/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset2_07_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(2/3), b=-3: m*x+b, 'deriv': lambda x, m=(2/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset3_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-2/3), b=-3: m*x+b, 'deriv': lambda x, m=(-2/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_extrapractice_07_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=3, b=-3: m*x+b, 'deriv': lambda x, m=3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_warmup3_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=-3, b=-3: m*x+b, 'deriv': lambda x, m=-3: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset1_07_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(1/3), b=-3: m*x+b, 'deriv': lambda x, m=(1/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset2_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-1/3), b=-3: m*x+b, 'deriv': lambda x, m=(-1/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset3_07_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(3/4), b=-3: m*x+b, 'deriv': lambda x, m=(3/4): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_extrapractice_08_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-3/4), b=-3: m*x+b, 'deriv': lambda x, m=(-3/4): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_cyu_03_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(4/3), b=-3: m*x+b, 'deriv': lambda x, m=(4/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset2_09_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(-4/3), b=-3: m*x+b, 'deriv': lambda x, m=(-4/3): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_practiceset3_09_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.2,5.2))
fig.patch.set_facecolor('white')
make_standard_graph(ax, [{'expr': lambda x, m=(5/2), b=-3: m*x+b, 'deriv': lambda x, m=(5/2): np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s23_extrapractice_09_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=8, b=10: m*x+b, 'deriv': lambda x, m=8: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=80, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_notesyti_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=8, b=15: m*x+b, 'deriv': lambda x, m=8: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=80, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset1_13_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=8, b=20: m*x+b, 'deriv': lambda x, m=8: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset1_14_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=8, b=25: m*x+b, 'deriv': lambda x, m=8: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset1_15_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=8, b=30: m*x+b, 'deriv': lambda x, m=8: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset2_13_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=8, b=35: m*x+b, 'deriv': lambda x, m=8: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset2_14_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=8, b=40: m*x+b, 'deriv': lambda x, m=8: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=120, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset2_15_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=10, b=10: m*x+b, 'deriv': lambda x, m=10: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset3_13_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=10, b=15: m*x+b, 'deriv': lambda x, m=10: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset3_14_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=10, b=20: m*x+b, 'deriv': lambda x, m=10: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_practiceset3_15_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=10, b=25: m*x+b, 'deriv': lambda x, m=10: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=120, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_extrapractice_13_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=10, b=30: m*x+b, 'deriv': lambda x, m=10: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=120, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_extrapractice_14_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=10, b=35: m*x+b, 'deriv': lambda x, m=10: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=120, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_extrapractice_15_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=10, b=40: m*x+b, 'deriv': lambda x, m=10: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=120, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_cyu_05_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_context_graph(ax, [{'expr': lambda x, m=12, b=10: m*x+b, 'deriv': lambda x, m=12: np.full_like(x,m,dtype=float), 'color': 'steelblue', 'label': None}], xmin=0, xmax=8, ymin=0, ymax=120, xlabel='Hours', ylabel='Distance (miles)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s22_exitticketa_03_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [4, 7, 8, 12, 14, 17], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Hours practiced', ylabel='Skill score gain', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset1_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [6, 8, 11, 13, 16, 18], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Weeks', ylabel='Reading rate gain', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset2_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [3, 6, 9, 11, 14, 17], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Sessions', ylabel='Accuracy gain', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset3_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [5, 8, 10, 13, 15, 19], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Practice sets', ylabel='Points improved', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_extrapractice_02_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [18, 16, 14, 13, 10, 8], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Age (years)', ylabel='Resale value (hundreds)', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset1_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [20, 17, 15, 12, 10, 7], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Hours after noon', ylabel='Temperature index', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset2_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [17, 15, 12, 11, 9, 6], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Use cycles', ylabel='Battery capacity index', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset3_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [19, 16, 15, 12, 8, 7], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Distance', ylabel='Signal strength', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_extrapractice_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [16, 15, 13, 10, 9, 6], xmin=0, xmax=7, ymin=0, ymax=25, line_of_best_fit=True, xlabel='Weeks', ylabel='Remaining inventory', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_exitticketa_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [2, 3, 6, 11, 18, 27], xmin=0, xmax=7, ymin=0, ymax=35, line_of_best_fit=False, xlabel='Time', ylabel='Measured value', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset2_03_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [1, 4, 7, 13, 21, 31], xmin=0, xmax=7, ymin=0, ymax=40, line_of_best_fit=False, xlabel='Input', ylabel='Observed output', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_practiceset3_03_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [3, 5, 9, 15, 23, 33], xmin=0, xmax=7, ymin=0, ymax=40, line_of_best_fit=False, xlabel='Stage', ylabel='Growth index', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_extrapractice_03_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [2, 5, 10, 17, 26, 37], xmin=0, xmax=7, ymin=0, ymax=45, line_of_best_fit=False, xlabel='Time', ylabel='Distance index', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_cyu_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.0,4.3))
fig.patch.set_facecolor('white')
make_scatter_plot(ax, [1, 2, 3, 4, 5, 6], [4, 6, 10, 16, 24, 34], xmin=0, xmax=7, ymin=0, ymax=40, line_of_best_fit=False, xlabel='Input', ylabel='Response value', title='')
fig.savefig(os.path.join(OUTPUT_DIR,'u2_s25_warmup2_01_repr.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
