...
if __name__ == '__main__':
    ...
    fig0=make_2x2_grid([[linear(1,0)],[quad(0.2,0,0)],[expo(1,1.45,0)],[absv(1,0,0)]],titles=['Linear','Quadratic','Exponential','Absolute value']); save_graph(fig0,'u4_s1_wtc.png'); plt.close(fig0)
    fig0=make_2x1_grid([[quad(0.25,0,0)],[quad(0.5,1,1)]],titles=['Parent','Transformed']); save_graph(fig0,'u4_s2_wtc.png'); plt.close(fig0)
    fig0=make_2x1_grid([[quad(0.25,0,0)],[quad(0.5,-1,2)]],titles=['Parent','Transformed']); save_graph(fig0,'u4_s3_wtc.png'); plt.close(fig0)
    make_algebra_tiles({'x2':1,'x':3,'one':2}, filename='u4_s4_wtc.png')
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(-0.25,-1,-2)],''); save_graph(fig0,'u4_s5_wtc.png'); plt.close(fig0)
