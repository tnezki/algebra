...
# UNIT 3 GENERATION CALLS — Representation/Figure Upgrade 3d clean set
if __name__ == "__main__":
    import matplotlib.pyplot as plt
    make_diamond(12, '', '', 7, filename='u3_31_wu1_diamond.png')
    make_diamond(-12, '', '', 1, filename='u3_32_wu1_diamond.png')
    make_diamond(18, '', '', 9, filename='u3_33_wu1_diamond.png')
    make_diamond(-20, '', '', -1, filename='u3_34_wu1_diamond.png')
    make_diamond(24, '', '', 10, filename='u3_35_wu1_diamond.png')
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=1.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_repr_u3_34_cyu_001.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=3.0, b=1.0: m*x+b, 'deriv': lambda x, m=3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_repr_u3_34_cyu_005.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_repr_u3_34_practice_set_1_003.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_repr_u3_34_practice_set_1_011.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=4.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}], title='')
    save_graph(fig, 'u3_repr_u3_34_practice_set_1_017.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=-1.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_repr_u3_35_cyu_001.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=6.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=-3.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_repr_u3_35_cyu_004.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=6.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=-1.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_repr_u3_35_practice_set_1_011.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=2.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_repr_u3_35_practice_set_1_017.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_105.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-1.0, b=0.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_117.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-0.5, b=0.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_119.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=0.5, b=0.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_126.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=1.0, b=0.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_133.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=2.0, b=0.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_200.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=4.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=3.0, b=-1.0: m*x+b, 'deriv': lambda x, m=3.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_203.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_21.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-1.0, b=3.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=1.0, b=-1.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_24.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=3.0, b=8.0: m*x+b, 'deriv': lambda x, m=3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-1.0, b=0.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_28.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=2.0, b=-9.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-0.5, b=1.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_35.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-1.0, b=-1.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=2.0, b=8.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_42.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-2.0, b=1.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_55.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-1.0, b=0.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_56.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=-0.5, b=0.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_63.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=0.5, b=0.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_70.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-2.0, b=4.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=1.0, b=-5.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_8.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=1.0, b=0.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_84.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=2.0, b=0.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_86.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-0.5, b=4.5: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=2.0, b=2.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_9.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=-3.0, b=0.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=3.0, b=0.0: m*x+b, 'deriv': lambda x, m=3.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_91.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=3.0, b=-5.0: m*x+b, 'deriv': lambda x, m=3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Equation 1'}, {'expr': lambda x, m=1.0, b=-3.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Equation 2'}], title='')
    save_graph(fig, 'u3_s31_g_98.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=1.0, b=1.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Plan A'}, {'expr': lambda x, m=0.5, b=4.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Plan B'}], title='')
    save_graph(fig, 'u3_s31_wtc.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=5.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=0.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_204.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=1.0, b=2.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Plan A'}, {'expr': lambda x, m=0.5, b=4.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Plan B'}], title='')
    save_graph(fig, 'u3_s33_p1_graph.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=1.5, b=1.0: m*x+b, 'deriv': lambda x, m=1.5: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Plan A'}, {'expr': lambda x, m=0.5, b=5.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Plan B'}], title='')
    save_graph(fig, 'u3_s33_p2_graph.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=2.0, b=0.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Plan A'}, {'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Plan B'}], title='')
    save_graph(fig, 'u3_s33_p3_graph.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=2.0, b=1.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'Plan A'}, {'expr': lambda x, m=0.5, b=7.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'label': 'Plan B'}], title='')
    save_graph(fig, 'u3_s33_p4_graph.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=-3.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_100.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=3.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_102.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=-2.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_114.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=3.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_117.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=-2.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_118.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=1.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_120.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-2.0, b=1.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_124.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=-1.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_126.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_130.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=2.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_132.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=-4.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_136.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-2.0, b=-2.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_150.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=1.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_16.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-3.0, b=1.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_200.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-2.0, b=-2.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_202.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_22.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=1.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_24.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=1.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_28.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_30.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-2.0, b=-3.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_34.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-2.0, b=4.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_36.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=3.0, b=2.0: m*x+b, 'deriv': lambda x, m=3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_40.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-3.0, b=3.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_42.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=1.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_52.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=-2.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_54.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=4.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_55.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=-2.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_58.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=1.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_60.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_64.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=3.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_66.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=-4.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_70.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=-3.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_72.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=1.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_8.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=-2.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_82.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=1.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_84.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=-3.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_86.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=1.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_88.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=3.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_9.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=-2.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_90.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-0.5, b=2.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_g_94.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=-4.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s34_g_96.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=2.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s34_wtc.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=6.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_102.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=6.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_105.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=4.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_114.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=3.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_117.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=3.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_120.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=6.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=1.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_123.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=8.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-3.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_126.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=6.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-1.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_129.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=7.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=2.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_132.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=7.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=1.0, b=1.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_135.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=5.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_15.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=7.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_150.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=4.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_200.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=2.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_201.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_21.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=3.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=5.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_24.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=1.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_27.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=5.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=-1.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_30.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=7.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=1.0, b=0.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_33.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=1.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_36.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=7.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_39.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=6.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=-1.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_42.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=4.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_51.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=5.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_54.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=3.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=5.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_55.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=7.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=-1.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_57.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=6.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_60.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=7.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=1.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_63.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=0.5, b=6.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=1.0, b=0.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_66.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=8.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_69.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=5.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_72.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=5.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_8.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_84.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_86.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=4.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=7.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_87.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=3.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=5.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_9.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=-1.0, b=6.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-1.0, b=0.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_90.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=6.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=-2.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': False}], title='')
    save_graph(fig, 'u3_s35_g_93.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=8.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=0.5, b=-1.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_96.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=2.0, b=7.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': False}, {'expr': lambda x, m=-2.0, b=0.0: m*x+b, 'deriv': lambda x, m=-2.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_g_99.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_inequality_graph(ax, [{'expr': lambda x, m=1.0, b=3.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'shade': 'below', 'inclusive': True}, {'expr': lambda x, m=-1.0, b=5.0: m*x+b, 'deriv': lambda x, m=-1.0: np.zeros_like(x)+m, 'color': 'firebrick', 'shade': 'above', 'inclusive': True}], title='')
    save_graph(fig, 'u3_s35_wtc.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=1.0, b=2.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'f'}], title='')
    save_graph(fig, 'u3_sum_v1_mg1g.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=2.0, b=1.0: m*x+b, 'deriv': lambda x, m=2.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'f'}], title='')
    save_graph(fig, 'u3_sum_v2_mg1g.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=3.0, b=0.0: m*x+b, 'deriv': lambda x, m=3.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'f'}], title='')
    save_graph(fig, 'u3_sum_v3_mg1g.png')
    plt.close(fig)
    fig, ax = plt.subplots(figsize=(5,5))
    make_standard_graph(ax, [{'expr': lambda x, m=4.0, b=-1.0: m*x+b, 'deriv': lambda x, m=4.0: np.zeros_like(x)+m, 'color': 'steelblue', 'label': 'f'}], title='')
    save_graph(fig, 'u3_sum_v4_mg1g.png')
    plt.close(fig)
