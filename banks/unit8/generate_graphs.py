...
if __name__ == '__main__':
    ...
    fig0=make_2x2_grid([[linear(1,0)],[quad(0.2,0,0)],[expo(1,1.45,0)],[absv(1,0,0)]],titles=['Linear','Quadratic','Exponential','Absolute value']); save_graph(fig0,'u8_s1_wtc.png'); plt.close(fig0)
    fig0=make_2x1_grid([[quad(0.25,0,0)],[quad(0.5,1,1)]],titles=['Parent','Transformed']); save_graph(fig0,'u8_s2_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[absv(1,-1,1)],''); save_graph(fig0,'u8_s3_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(6.2,4.8)); make_scatter_plot(ax,[1, 2, 3, 4, 5, 6, 7, 8],[6, 9, 9, 12, 15, 15, 18, 21],0,9,0,25,line_of_best_fit=True,xlabel='Input',ylabel='Observed output',title=''); save_graph(fig0,'u8_s4_wtc.png'); plt.close(fig0)
    fig0=make_2x2_grid([[linear(1,0)],[quad(0.2,0,0)],[expo(1,1.45,0)],[absv(1,0,0)]],titles=['Linear','Quadratic','Exponential','Absolute value']); save_graph(fig0,'u8_s5_wtc.png'); plt.close(fig0)
