...
if __name__ == '__main__':
    ...
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(-0.25,-1,-1)],''); save_graph(fig0,'u6_s1_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(0.25,0,0)],''); save_graph(fig0,'u6_s2_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(-0.25,1,1)],''); save_graph(fig0,'u6_s3_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(0.25,-2,2)],''); save_graph(fig0,'u6_s4_wtc.png'); plt.close(fig0)
    fig0,ax=plt.subplots(figsize=(5.4,5.4)); make_standard_graph(ax,[quad(-0.25,-1,-2)],''); save_graph(fig0,'u6_s5_wtc.png'); plt.close(fig0)
