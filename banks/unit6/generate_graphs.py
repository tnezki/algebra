...
# UNIT 6 GENERATION CALLS — appended per Base Bank contract

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-2)*(x+4), 'deriv': lambda x: 2*x+2, 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_wtc.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

make_rectangle_model(['$x$', '$3$'], ['$x$', '$3$'], [['$x^2$', '$3x$'], ['$3x$', '$9$']], filename='u6_s2_wtc.png')

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: x**2-4, 'deriv': lambda x: 2*x, 'color': 'steelblue', 'label': 'f'}, {'expr': lambda x: (x-1)**2, 'deriv': lambda x: 2*(x-1), 'color': 'firebrick', 'label': 'g'}, {'expr': lambda x: (x-1)**2+3, 'deriv': lambda x: 2*(x-1), 'color': 'darkorange', 'label': 'h'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_wtc.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -5*x**2+20*x+1, 'deriv': lambda x: -10*x+20, 'color': 'steelblue'}], xmin=0, xmax=4.2, ymin=0, ymax=23, xlabel='Time (s)', ylabel='Height (m)', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_wtc.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x+3)*(x-1), 'deriv': lambda x: 2*x+2, 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_ex3.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-4)*(x+2), 'deriv': lambda x: 2*x-2, 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_yti3.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x+2)**2-5, 'deriv': lambda x: 2*(x+2), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_ex4.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-3)**2-4, 'deriv': lambda x: 2*(x-3), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_yti4.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

make_rectangle_model(['$x$', '$4$'], ['$x$', '$4$'], [['$x^2$', '$4x$'], ['$4x$', '$16$']], filename='u6_s2_ex5.png')

make_rectangle_model(['$x$', '$2$'], ['$x$', '$2$'], [['$x^2$', '$2x$'], ['$2x$', '$4$']], filename='u6_s2_yti5.png')

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: x**2+4*x-5, 'deriv': lambda x: 2*x+4, 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_ex5.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: x**2+2*x+4, 'deriv': lambda x: 2*x+2, 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_yti5.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -2*x**2+12*x+2, 'deriv': lambda x: -4*x+12, 'color': 'steelblue'}], xmin=0, xmax=6.5, ymin=0, ymax=23, xlabel='Time (s)', ylabel='Height (m)', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_ex3.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -4*x**2+16*x+2, 'deriv': lambda x: -8*x+16, 'color': 'steelblue'}], xmin=0, xmax=4.2, ymin=0, ymax=20, xlabel='Time (s)', ylabel='Height (m)', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_yti3.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(-3))*(x-(4)), 'deriv': lambda x: 2*x-(1), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_p1_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(-2))*(x-(5)), 'deriv': lambda x: 2*x-(3), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_p2_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(-1))*(x-(6)), 'deriv': lambda x: 2*x-(5), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_p3_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(0))*(x-(7)), 'deriv': lambda x: 2*x-(7), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_p4_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(-2))**2+(-4), 'deriv': lambda x: 2*(x-(-2)), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_p1_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(-1))**2+(-3), 'deriv': lambda x: 2*(x-(-1)), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_p2_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(0))**2+(-2), 'deriv': lambda x: 2*(x-(0)), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_p3_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(1))**2+(-1), 'deriv': lambda x: 2*(x-(1)), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_p4_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-1)**2+(-4), 'deriv': lambda x: 2*(x-1), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_p1_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-1)**2+(0), 'deriv': lambda x: 2*(x-1), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_p2_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-1)**2+(3), 'deriv': lambda x: 2*(x-1), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_p3_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x+3)**2-1, 'deriv': lambda x: 2*(x+3), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_p4_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -1*(x-(3))**2+(19), 'deriv': lambda x: -2*(x-(3)), 'color': 'steelblue'}], xmin=0, xmax=8, ymin=0, ymax=22, xlabel='Input', ylabel='Output', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_p1_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -1*(x-(4))**2+(20), 'deriv': lambda x: -2*(x-(4)), 'color': 'steelblue'}], xmin=0, xmax=10, ymin=0, ymax=23, xlabel='Input', ylabel='Output', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_p2_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -1*(x-(5))**2+(21), 'deriv': lambda x: -2*(x-(5)), 'color': 'steelblue'}], xmin=0, xmax=12, ymin=0, ymax=24, xlabel='Input', ylabel='Output', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_p3_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -1*(x-(6))**2+(22), 'deriv': lambda x: -2*(x-(6)), 'color': 'steelblue'}], xmin=0, xmax=14, ymin=0, ymax=25, xlabel='Input', ylabel='Output', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_p4_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(1))*(x-(8)), 'deriv': lambda x: 2*x-(9), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_p5_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(2))**2+(0), 'deriv': lambda x: 2*(x-(2)), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_p5_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x+3)**2-4, 'deriv': lambda x: 2*(x+3), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_p5_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -1*(x-(7))**2+(23), 'deriv': lambda x: -2*(x-(7)), 'color': 'steelblue'}], xmin=0, xmax=16, ymin=0, ymax=26, xlabel='Input', ylabel='Output', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_p5_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

make_diamond('$12$', '', '', '$7$', filename='u6_s1_wu1_diamond.png')

make_diamond('$-18$', '$3$', '', '', filename='u6_s2_wu1_diamond.png')

make_diamond('', '$-4$', '$5$', '', filename='u6_s3_wu1_diamond.png')

make_diamond('$25$', '', '', '$10$', filename='u6_s4_wu1_diamond.png')

make_diamond('$20$', '', '', '$9$', filename='u6_s5_wu1_diamond.png')

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(4))*(x-(11)), 'deriv': lambda x: 2*x-(15), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s1_p8_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-(5))**2+(3), 'deriv': lambda x: 2*(x-(5)), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s2_p8_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: (x-4)**2, 'deriv': lambda x: 2*(x-4), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s3_p8_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(6.2,4.3))
make_context_graph(ax, [{'expr': lambda x: -1*(x-(10))**2+(26), 'deriv': lambda x: -2*(x-(10)), 'color': 'steelblue'}], xmin=0, xmax=22, ymin=0, ymax=29, xlabel='Input', ylabel='Output', title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s5_p8_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: abs(x+4)-2, 'deriv': lambda x: np.where(x>=-4,1.0,-1.0), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s4_p1_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: 0.5*abs(x-1)+1, 'deriv': lambda x: np.where(x>=1,0.5,-0.5), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s4_p2_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: 2*abs(x-3)-1, 'deriv': lambda x: np.where(x>=3,2.0,-2.0), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s4_p3_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: abs(x+1)+3, 'deriv': lambda x: np.where(x>=-1,1.0,-1.0), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_s4_p4_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: abs(x-1)+2, 'deriv': lambda x: np.where(x>=1,1.0,-1.0), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_sum_mg01_v14.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: abs(x+3)-1, 'deriv': lambda x: np.where(x>=-3,1.0,-1.0), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_sum_mg01_v24.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: 0.5*abs(x-2)+3, 'deriv': lambda x: np.where(x>=2,0.5,-0.5), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_sum_mg01_v34.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: 2*abs(x+1)-2, 'deriv': lambda x: np.where(x>=-1,2.0,-2.0), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_sum_mg01_v44.png'), dpi=144, bbox_inches='tight')
plt.close(fig)

fig, ax = plt.subplots(figsize=(5.4,5.4))
make_standard_graph(ax, [{'expr': lambda x: -0.5*(x+2)**2+3, 'deriv': lambda x: -(x+2), 'color': 'steelblue'}], title='')
fig.savefig(os.path.join(OUTPUT_DIR, 'u6_sum_v6_mg02_graph.png'), dpi=144, bbox_inches='tight')
plt.close(fig)
