...
make_scatter_plot(ax,[0,1,2,3,4,5],[50,61,75,90,111,134],0,6,0,150,xlabel='Time',ylabel='Measured value',title='Observed Growth Data')
save_graph(fig,'exp_scatter.png'); plt.close(fig)
