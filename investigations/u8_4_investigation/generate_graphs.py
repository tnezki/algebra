...
make_scatter_plot(ax,[0,1,2,3,4,5,6],[3,5,8,13,19,27,37],0,7,0,42,xlabel='Input',ylabel='Observed output',title='Unlabeled Data')
save_graph(fig,'model_data.png'); plt.close(fig)
