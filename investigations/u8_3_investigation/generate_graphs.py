...
make_standard_graph(ax,[{'expr':lambda x:np.abs(x-2),'deriv':lambda x:np.where(x<2,-1,1),'color':'steelblue'}],title='Absolute Value as Two Linear Pieces')
save_graph(fig,'absolute_piecewise.png'); plt.close(fig)
