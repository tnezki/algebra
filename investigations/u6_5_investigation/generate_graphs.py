...
make_context_graph(ax,[{'expr':lambda x:-x**2+12*x,'deriv':lambda x:-2*x+12,'color':'steelblue'}],0,12,0,40,xlabel='Side length x (m)',ylabel='Area (m^2)',title='Garden Area')
save_graph(fig,'area_graph.png'); plt.close(fig)
