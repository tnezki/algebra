...
# Unit 0A progress tracker graph-generation blocks appended below the source marker.
# Existing graph_tool.py source above this point is copied unchanged.

def _pt_blank_number_line(filename, label=None, xmin=-10, xmax=10):
...
def _pt_number_line(filename, intervals, xmin=-10, xmax=10):
    fig, ax = plt.subplots(figsize=(3.5, 1.25))
    fig.patch.set_facecolor('white')
...
if __name__ == '__main__':
    _pt_blank_number_line('u0A_pt_numberline_blank.png', label=r'$-10\leq x\leq 10$')
    _pt_number_line('u0A_pt_inequality_graph_01.png', [
        {'start': -2, 'end': None, 'start_open': False, 'end_open': True, 'direction': 'right', 'color': 'steelblue'}
    ])
    make_rectangle_model([r'$x$', r'$2$'], [r'$x$', r'$5$'], [['', ''], ['', '']], 'u0A_pt_area_blank_01.png')
    make_rectangle_model([r'$x$', r'$2$'], [r'$x$', r'$4$'], [[r'$x^2$', r'$4x$'], [r'$2x$', r'$6$']], 'u0A_pt_area_mismatch_01.png')
