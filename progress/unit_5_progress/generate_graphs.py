...
# Unit 5 progress tracker figure generation
...
_pt_standard('u5_pt_blank_grid_01.png', [])

make_rectangle_model([r'$4x$'], [r'$x$', r'$3$'], [[r'$4x^2$', r'$12x$']], 'u5_pt_gcf_area_01.png')
make_diamond(r'$-24$', '', '', r'$2$', 'u5_pt_diamond_01.png')
make_rectangle_model([r'$x$', r'$2$'], [r'$x$', r'$5$'], [[r'$x^2$', r'$5x$'], [r'$2x$', r'$12$']], 'u5_pt_area_mismatch_01.png')

_pt_standard('u5_pt_graph_mismatch_01.png', [
    {'expr': lambda x: (x-2)*(x-4), 'deriv': lambda x: 2*x-6, 'color': 'steelblue'}
], title='')
