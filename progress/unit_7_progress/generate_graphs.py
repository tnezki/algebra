...
# Unit 7 progress tracker figure generation

def _pt_exp(a, b, d=0.0, c=0.0, color='steelblue', label=None):
    return {
...
def _pt_line(m, b, color='firebrick', label=None):
    return {
        'expr': lambda x: m*x + b,
...
def _pt_standard(filename, functions=None, title=''):
...
def _pt_context(filename, functions, xmin, xmax, ymin, ymax, xlabel='x', ylabel='y', title=''):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    fig.patch.set_facecolor('white')
    make_context_graph(ax, functions, xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax, xlabel=xlabel, ylabel=ylabel, title=title)
    save_graph(fig, filename)
    plt.close(fig)

def _pt_scatter(filename, x_data, y_data, xmin, xmax, ymin, ymax, xlabel='x', ylabel='y', title=''):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    fig.patch.set_facecolor('white')
    make_scatter_plot(ax, x_data, y_data, xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax,
                      color='steelblue', point_size=36, line_of_best_fit=False,
                      xlabel=xlabel, ylabel=ylabel, title=title)
    save_graph(fig, filename)
    plt.close(fig)

_pt_standard('u7_pt_blank_grid_01.png', [])

_pt_context('u7_pt_growth_graph_01.png', [
    _pt_exp(2, 1.8, color='steelblue')
], xmin=0, xmax=6, ymin=0, ymax=75, xlabel='Time', ylabel='Amount', title='')

_pt_context('u7_pt_decay_graph_01.png', [
    _pt_exp(80, 0.5, color='steelblue')
], xmin=0, xmax=6, ymin=0, ymax=85, xlabel='Time', ylabel='Amount', title='')

_pt_context('u7_pt_shifted_decay_01.png', [
    _pt_exp(48, 0.5, d=3, color='steelblue')
], xmin=0, xmax=6, ymin=0, ymax=55, xlabel='Time', ylabel='Amount', title='')

_pt_context('u7_pt_linear_exp_compare_01.png', [
    _pt_line(8, 10, color='firebrick', label='L'),
    _pt_exp(5, 1.7, color='steelblue', label='E')
], xmin=0, xmax=8, ymin=0, ymax=100, xlabel='Week', ylabel='Total', title='')

_pt_scatter('u7_pt_scatter_growth_01.png', [0,1,2,3,4,5,6], [50,78,119,185,282,430,670],
            xmin=0, xmax=6, ymin=0, ymax=700, xlabel='Day', ylabel='Amount', title='')
