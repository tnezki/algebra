...
# Unit 4 progress tracker figure generation
...
def _pt_two_grid(filename, functions_list, titles=None):
    fig = make_2x1_grid(functions_list, titles=titles)
    save_graph(fig, filename)
    plt.close(fig)

_pt_standard('u4_pt_blank_grid_01.png', [])


_pt_two_grid('u4_pt_translation_abs_01.png', [
...
make_rectangle_model([r'$x$', r'$6$'], [r'$x$', r'$-4$'], [['', ''], ['', '']], 'u4_pt_area_blank_01.png')
make_rectangle_model([r'$x$', r'$2$'], [r'$x$', r'$5$'], [[r'$x^2$', r'$5x$'], [r'$2x$', r'$10$']], 'u4_pt_area_mismatch_01.png')

_pt_standard('u4_pt_quadratic_features_01.png', [
