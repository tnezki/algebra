...
# Unit 6 progress tracker figure generation
...
_pt_standard('u6_pt_blank_grid_01.png', [])

_pt_standard('u6_pt_factor_graph_01.png', [
    {'expr': lambda x: x**2 - 8*x + 7, 'deriv': lambda x: 2*x - 8, 'color': 'steelblue'}
], title='')

_pt_standard('u6_pt_no_real_01.png', [
    {'expr': lambda x: x**2 + 2*x + 5, 'deriv': lambda x: 2*x + 2, 'color': 'steelblue'}
], title='')

_pt_context('u6_pt_height_context_01.png', [
    {'expr': lambda x: -x**2 + 6*x + 7, 'deriv': lambda x: -2*x + 6, 'color': 'steelblue'}
], xmin=0, xmax=8, ymin=0, ymax=18, xlabel='Time (s)', ylabel='Height (ft)', title='')
