...
# Unit 3 progress tracker figure generation

def _pt_standard(filename, functions=None):
...
def _pt_ineq(filename, inequalities):
    fig, ax = plt.subplots(figsize=(3.5, 3.5))
    fig.patch.set_facecolor('white')
...
_pt_standard('u3_pt_blank_grid_01.png', [])
_pt_standard('u3_pt_intersecting_system_01.png', [
...
_pt_ineq('u3_pt_wrong_ineq_01.png', [
    {'expr': lambda x: -1*x + 4, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'steelblue', 'shade': 'above', 'inclusive': True},
])
_pt_ineq('u3_pt_wrong_system_region_01.png', [
    {'expr': lambda x: -1*x + 9, 'deriv': lambda x: np.full_like(x, -1.0), 'color': 'steelblue', 'shade': 'below', 'inclusive': True},
